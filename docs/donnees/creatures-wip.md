...
2/jour chacun : _[déguisement](), [invisibilité]()_ (personnel uniquement)  
**Téméraire**.  
**Saut avec élan**.  
A|**Attaques multiples**.  
A|**Morsure**. +7, 1,50 m, 2d6+4 perforants  
...
A|**Attaques multiples**.  
A|**Morsure**. +10, 3 m, 3d10+6 perforants  
A|**Constriction**. +10, 1,50 m, 2d10+6 contondants  
...
**Immunités** feu, poison  
**Immunités** empoisonné, charmé, effrayé  
**Sens** vision véritable 36 m, Perception passive 13  
**Langues** abyssal, télépathie 36 m  
...
A|**Fouet**.  
A|**Tempête abyssal (Recharge 5-6)**.  
A|**Téléportation**.  
A|**Battement d'ailes**.  
...
**Regard mortel**.  
**Hypersensibilité au soleil**.  
A|**Poing**. +5, 1,50 m, 1d4+2 contondants  
...
Fée de taille P, typiquement chaotique mauvais
...
**Force hors normes**.  
A|**Attaques multiples**.  
A|**Serpe mauvaise**. +6, 1,50 m, 2d4+4 tranchants  
A|**Poursuite de fer**.  
...
A|**Attaques multiples**.  
A|**Fouet**. +5, 3 m, 1d4+3 tranchants  
A|**Dague +1**. +6, 1,50 m ou 6/18 m, 1d4+4 perforants  
R|**Parade**.  
...
**Défense élégante**.  
A|**Attaques multiples**.  
A|**Dague**. +6, 1,50 m ou 6/18 m, 1d4+4 perforants  
...
**Saut sans élan**.  
A|**Morsure**. +7, 1,50 m, 4d12+4 perforants  
A|**Saut implacable**.  
...
**Ouïe aiguisée**.  
A|**Attaques multiples**.  
A|**Morsures**. +11, 1,50 m, 3d8+8 perforants  
...
**Résistances** foudre, feu, froid, poison ; contondant, perforant et tranchant d'attaques non magiques  
**Sens** vision dans le noir 18 m, Perception passive 14  
...
**Faveur impie**.  
**Incantation innée**.  
3/jour chacun : _[détection de la magie](), [injonction](), [modification d'apparence]()_  
1/jour : _[changement de plan]()_ (personnel uniquement)  
A|**Attaques multiples**.  
A|**Lance**. +7, 1,50 m ou 6/12 m, 1d6+4 perforants  
A|**Rayon de feu**. +7, 36 m, 3d6 feu  
A|**Charme satanique**.  
...
**Odorat aiguisé**.  
**Puanteur**.  
A|**Queue**. +7, 3 m, 5d6+4 contondants  
...
**Charge**.  
A|**Attaques multiples**.  
A|**Pique**. +6, 3 m, 1d10+4 perforants  
...
**Immunités** poison  
**Immunités** épuisement, paralysé, empoisonné, à terre  
...
Aberration de taille Gig, typiquement loyal mauvais
...
**Résistance à la magie**.  
**Relai télépathique**.  
A|**Tentacule**. +7, 9 m, 4d8+2 contondants  
A|**Explosion de l'esprit (Recharge 5-6)**.  
A|**Lien psychique**.  
A|**Perception des pensées**.  
L|**Tentacule**.  
L|**Rupture de concentration**.  
L|**Pulsation psychique**.  
...
**Incantation innée**.  
À volonté : _[lumières dansantes](), [main de mage](), [message](), [thaumaturgie]()_  
1/jour chacun : _[augure](), [malédiction](), [cordon de flèches](), [détection de la magie](), maléfice, [prière de guérison](), a href="">communication avec les morts, [esprits gardiens]()_  
A|**Lance**. +4, 1,50 m ou 6/18 m, 1d6+2 perforants  
...
A|**Arc court**. +6, 24/96 m, 1d6+2 perforants  
...
**Pattes d'araignée**.  
A|**Attaques multiples**.  
A|**Tentacules**. +8, 3 m, 1d4+2 poison  
...
Humanoïde (gobelin, métamorphe) de taille P, neutre mauvais
...
**Sensibilité au soleil**.  
A|**Attaques multiples (forme humanoïde ou hybride uniquement)**.  
A|**Morsure (forme de chauve-souris ou hybride uniquement)**. +5, 1,50 m, 1d6+3 perforants  
A|**Cimeterre (forme humanoïde ou hybride uniquement)**.  
...
**Brave**.  
A|**Attaques multiples**.  
A|**Épée à deux mains**. +5, 1,50 m, 2d6+3 tranchants  
...
**Immunités** nécrotique, poison  
**Immunités** effrayé, épuisement, empoisonné  
...
**Incantation**.  
Niv 1 (4) : _[châtiment calcinant](), [duel forcé](), [injonction]()_  
Niv 2 (3) : _[arme magique](), [immobilisation de personne]()_  
Niv 3 (3) : _[arme élémentaire](), [dissipation de la magie]()_  
Niv 4 (3) : _[bannissement](), [châtiment débilitant]()_  
Niv 5 (2) : _[vague destructrice]()_ (nécrotique)  
A|**Attaques multiples**.  
A|**Épée longue**. +11, 1,50 m, 1d8+5 tranchants  
A|**Flammes impies (1/jour)**.  
R|**Parade**.  
...
Humanoïde (paladin) de taille M, typiquement neutre mauvais
...
A|**Attaques multiples**.  
A|**Coutille**. +7, 3 m, 1d10+4 tranchants  
A|**Arc court**. +3, 24/96 m, 1d6+2 perforants  
A|**Aspect épouvantable (Recharge après un repos court ou long)**.  
A|**Incantation**.  
2/jour chacun : _[injonction](), [dissipation de la magie](), [appel de destrier]()_  
B|**Châtiment**.  
B|**Aveuglé**.  
B|**Repoussé**.  
...
**Incantation**.  
Niv 1 (4) : _[injonction](), [protection contre le mal et le bien](-et-le-bien), [châtiment tonitruant]()_  
Niv 2 (3) : _[châtiment révélateur](évélateur), [appel de destrier]()_  
Niv 3 (2) : _[châtiment aveuglant](), [dissipation de la magie]()_  
A|**Attaques multiples**.  
A|**Coutille**. +7, 3 m, 1d10+4 tranchants  
A|**Arc court**. +3, 24/96 m, 1d6+2 perforants  
A|**Aspect épouvantable (Recharge après un repos court ou long)**.  
...
**Banni par le soleil**.  
**Lien télépathique**.  
A|**Morsure**. +6, 1,50 m, 2d6+4 perforants  
...
A|**Attaques multiples**.  
A|**Cornes**. +7, 1,50 m, 1d12+4 contondants  
...
**Ascendance féerique**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[assistance](), [réparation](), [résistance](), [thaumaturgie]()_  
Niv 1 (4) : _[fléau](), [mot de guérison](), [sanctuaire](), [bouclier de la foi]()_  
Niv 2 (3) : _[immobilisation de personne](), [arme spirituelle]()_ (dague)  
**Pattes d'araignée**.  
**Sensibilité au soleil**.  
**Sens de la toile**.  
**Déplacement sur la toile**.  
...
A|**Attaques multiples**.  
A|**Pinces**. +6, 3 m, 2d6+4 contondants  
A|**Tentacules**.  
...
\[ Cadaver Collector \] \[ Collecteur cadavéreux \]
...
**Rôle martial**.  
A|**Épée longue**. +4, 1,50 m, 1d8+2 tranchants  
...
**Second souffle**.  
**Critique amélioré**.  
A|**Épée longue**. +5, 1,50 m, 1d8+3 tranchants  
A|**Arc long**. +3, 45/180 m, 1d8+1 perforants  
R|**Protection (défenseur seulement)**.  
...
A|**Arc long**. +4, 45/180 m, 1d8+1 perforants  
R|**Protection (défenseur seulement)**.  
...
**Sens** darkvision vision dans le noir 12 m, Perception passive 12  
**Langues** draconique  
**Puissance** - **Bonus de maîtrise** égal à votre bonus
...
**Discipline tactique**.  
A|**Attaques multiples**.  
A|**Lance**. +5, 1,50 m ou 6/18 m, 1d6+3 perforants  
A|**Voix autoritaire**.  
...
**Incantation innée**.  
À volonté : _[détection du mal et du bien](-du-bien), [détection de la magie](), [détection des pensées]()_  
3/jour chacun : _[bénédiction](), [bouclier](), [création de nourriture et d'eau](-d-eau), [protection contre le poison](), [restauration partielle](), [sanctuaire](), [soins]()_  
1/jour chacun : _[restauration supérieure](), [scrutation](), [songe]()_  
**Armes magiques**.  
**Esprit fortifié**.  
A|**Morsure**. +8, 1,50 m, 1d6+5 perforants  
A|**Constriction**. +6, 3 m, 2d6+3 contondants  
...
\[ Giant Strider \] \[ Coursier des brasiers \]
...
**Immunités** feu, froid, poison  
**Immunités** à terre, charmé, empoisonné, paralysé, effrayé  
**Sens** vision dans le noir 18 m, Perception passive 12  
**Langues** commun  
**Puissance** 4 (1100 PX)
...
**Reconstitution**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[main de mage]()_  
Niv 1 (3 de sorts) : _[bouclier](), [projectile magique]()_  
Niv 2 (2 de sorts) : _[flou](), [sphère de feu]()_  
Niv 3 (1 de sort) : _[boule de feu]()_  
A|**Attaques multiples**.  
...
**Apnée**.  
A|**Attaques multiples**.  
A|**Morsure**. +8, 1,50 m, 3d10+5 perforants  
...
**Vase cubique**.  
**Transparent**.  
A|**Pseudopode**. +4, 1,50 m, 3d6 acide  
A|**Engloutissement**.  
...
Monstruosité (titan) de taille Gig, sans alignement
...
Griffes.  
Griffes.  
Visite du Donjon (coûte 2 actions).  
...
**Rompre le cordon argenté**.  
A|**Attaques multiples**.  
A|**Morsure**. +16, 3 m, 5d10+9 perforants  
A|**Griffes**. +16, 6 m, 3d6+9 tranchants  
L|**Griffes**.  
L|**Visite du Donjon (coûte 2 actions)**.  
...
Géant de taille TG, chaotique neutre
...
A|**Attaques multiples**.  
A|**Massue**. +9, 3 m, 3d8+6 contondants  
...
**Incantation innée**.  
À volonté : _[détection de la magie](), [détection du mal et du bien](-du-bien), [façonnage de la pierre]()_  
3/jour : _[don des langues](), [passe-muraille](), [terraformage]()_  
1/jour chacun : _[assassin imaginaire](), [changement de plan](), [invocation d'élémentaire]()_ (élémentaire de la terre uniquement), _[forme gazeuse](), [invisibilité](), [mur de pierre]()_  
**Déplacement dans la terre**.  
**Pieds sûrs**.  
A|**Attaques multiples**.  
A|**Poing**. +10, 1,50 m, 2d8+6 contondants  
...
Fée de taille M, typiquement chaotique bon
...
A|**Attaques multiples**.  
A|**Épée longue**. +5, 1,50 m, 1d8+3 tranchants  
A|**Épée courte**. +5, 1,50 m, 1d6+3 perforants  
...
**Immunités** nécrotique, poison, psychique ; contondant, perforant et tranchant d'attaques non magiques  
**Immunités** charmé, assourdi, épuisement, effrayé, paralysé, pétrifié, empoisonné, à terre, étourdi  
**Sens** vision véritable 36 m, Perception passive 13  
**Langues** —  
**Puissance** 18 (20000 PX)
...
**Résistance légendaire (3/jour)**.  
**Immunité au renvoi**.  
A|**Hurlement (Recharge 5-6)**.  
A|**Absorption de vie**.  
L|**Envolée**.  
L|**Nuage de poussière**.  
L|**Absorption d'énergie (coûte 2 actions)**.  
...
A|**Hache d'armes**. +5, 1,50 m, 2d8+3 tranchants  
...
**Incantation innée**.  
À volonté : _[détection de la magie](), [image majeure]()_  
3/jour chacun : _[dissipation de la magie](), peur, [télékinésie]()_  
1/jour chacun : _[esprit faible](), [projection d'image]()_  
**Résistance légendaire (3/jour)**.  
**Résistance à la magie**.  
**Armes magiques**.  
**Deux têtes**.  
A|**Attaques multiples**.  
A|**Tentacule**. +17, 3 m, 3d12+9 contondants  
A|**Regard**.  
A|**1- Regard séduisant**.  
A|**2- Regard hypnotique**.  
A|**3- Regard dément**.  
L|**Queue**. +17, 4,50 m, 2d10+9 contondants  
...
**Résistances** acide, feu, nécrotique, tonnerre ; contondant, perforant et tranchant d'attaques non magiques  
**Immunités** froid, foudre, poison  
**Immunités** épuisement, agrippé, paralysé, pétrifié, empoisonné, à terre, entravé  
**Sens** vision dans le noir 36 m, Perception passive 11  
**Langues** abyssal, télépathie 36 m  
**Puissance** 4 (1100 PX)
...
**Incantation**.  
Sorts mineurs (à volonté) : _[illusion mineure](), [lumière](), [prestidigitation](), [trait de feu]()_  
Niv 1 (4) : _[armure de mage](), [bouclier](), [projectile magique](), [sommeil]()_  
Niv 2 (3) : _[déblocage](), [suggestion]()_  
Niv 3 (3) : _[boule de feu](), [contresort](), [vol]()_  
Niv 4 (3) : _[invisibilité supérieure](), [tempête de grêle]()_  
Niv 5 (1) : _[cône de froid]()_  
...
**Résistances** radiant ; contondant, perforant et tranchant d'attaques non magiques  
...
**Armes angéliques**.  
**Incantation innée**.  
À volonté : _[détection du mal et du bien](-du-bien)_  
1/jour chacun : _[communion](), [rappel à la vie]()_  
**Résistance à la magie**.  
A|**Attaques multiples**.  
...
Monstruosité de taille G, typiquement chaotique neutre
...
**Incantation**.  
Sorts mineurs (à volonté) : _[trait de feu](), [lumière](), [main de mage](), [message](), [coup au but]()_  
Niv 1 (4) : _[détection de la magie]()\*, [feuille morte](), [armure de mage]()_  
Niv 2 (3) : _[détection des pensées]()\*, [localisation d'objet]()\*, [rayon ardent]()_  
Niv 3 (3) : _[clairvoyance]()\*, [vol](), [boule de feu]()_  
Niv 4 (3) : _[oeil magique]()\*, [tempête de grêle](), [peau de pierre]()_  
Niv 5 (2) : _[lien télépathique de Rary]()\*, [scrutation]()\*_  
Niv 6 (1) : _[suggestion de groupe](), [vision suprême]()\*_  
Niv 7 (1) : _[boule de feu à retardement](-retardement), [boule de feu](), [téléportation]()_  
Niv 8 (1) : _[dédale]()_  
...
Mort-vivant de taille G, typiquement chaotique mauvais
...
\[ Chain Devil \] \[ Diable des chaînes \]
...
**Armes magiques**.  
**Incantation innée**.  
À volonté : _[détection de la magie](), [boule de feu]()_  
3/jour chacun : _[immobilisation de monstre](), [mur de feu]()_  
A|**Attaques multiples**.  
...
**Disparition élémentaire**.  
**Incantation innée**.  
À volonté : _[détection du mal et du bien](-du-bien), [détection de la magie](), [vague tonnante]()_  
3/jour chacun : _[création de nourriture et d'eau](-d-eau)_ (peut créer du vin à la place de l'eau), _[don des langues](), [marche sur le vent]()_  
1/jour chacun : _[invocation d'élémentaire]()_ (élémentaire de l'air uniquement), _[création](), [forme gazeuse](), [invisibilité](), [image majeure](), [changement de plan]()_  
A|**Attaques multiples**.  
...
A|**Morsure**. +13, 3 m, 2d10+7 perforants  
A|**Queue**. +13, 4,50 m, 2d8+7 contondants  
A|**Présence terrifiante**.  
A|**Souffle de foudre (Recharge 5-6)**.  
L|**Détection**.  
L|**Attaque avec la queue**.  
...
\[ Draconian Mastermind \] \[ Draconien, stratège \]
...
Monstruosité de taille G, tout alignement
...
Aberration de taille G, typiquement loyal mauvais
...
**Ascendance féerique**.  
**Incantation innée**.  
À volonté : _[ténèbres]()_  
1/jour chacun : _[confusion](), [lumières dansantes](), [lueurs féeriques]()_  
A|**Attaques multiples**.  
...
A|**Queue**. +11, 4,50 m, 2d8+6 contondants  
A|**Présence terrifiante**.  
...
\[ Ancient White Dragon \] \[ Dragon blanc, vénérable \]
...
A|**Queue**. +14, 6 m, 2d8+8 contondants  
A|**Présence terrifiante**.  
A|**Souffle de froid (Recharge 5-6)**.  
L|**Détection**.  
L|**Attaque avec la queue**.  
...
A|**Queue**. +12, 4,50 m, 2d8+7 contondants  
A|**Présence terrifiante**.  
A|**Souffle de foudre (Recharge 5-6)**.  
L|**Détection**.  
L|**Attaque avec la queue**.  
...
\[ Ancient Blue Dragon \] \[ Dragon bleu, vénérable \]
...
A|**Queue**. +16, 6 m, 2d8+9 contondants  
A|**Présence terrifiante**.  
A|**Souffle de foudre (Recharge 5-6)**.  
L|**Détection**.  
L|**Attaque avec la queue**.  
...
\[ Ancient Brass Dragon \] \[ Dragon d'airain, vénérable \]
...
Dragon (métallique) de taille G, chaotique bon
...
Dragon (diamantin) de taille TG, typiquement neutre
...
A|**Attaques multiples**.  
A|**Morsure**. +12, 3 m, 2d10+7 perforants  
A|**Griffes**. +12, 3 m, 1d8+7 tranchants  
A|**Incantation (psioniques)**.  
1/jour chacun : _[clignotement](), [contrôle de l'eau](), [dissipation de la magie](), [protection contre le mal et le bien](-et-le-bien), [communication à distance]()_  
A|**Souffle singulier (Recharge 5-6)**.  
...
\[ Ancient Amethyst Dragon \] \[ Dragon d'améthyste, vénérable \]

Dragon (diamantin) de taille Gig, typiquement neutre
...
Dragon (diamantin) de taille G, typiquement neutre
...
A|**Queue**. +13, 4,50 m, 2d8+8 contondants  
A|**Présence terrifiante**.  
A|**Souffle de combat (Recharge 5-6)**.  
A|**Souffle de froid**.  
...
\[ Ancient Silver Dragon \] \[ Dragon d'argent, vénérable \]
...
A|**Queue**. +17, 6 m, 2d8+10 contondants  
A|**Présence terrifiante**.  
A|**Souffle de combat (Recharge 5-6)**.  
A|**Souffle de froid**.  
A|**Souffle paralysant**.  
...
Dragon (diamantin) de taille TG, typiquement loyal neutre
...
A|**Attaques multiples**.  
A|**Morsure**. +11, 3 m, 2d10+6 perforants  
A|**Griffes**. +11, 1,50 m, 1d8+6 tranchants  
A|**Incantation (psioniques)**.  
À volonté : _[main de mage]()_ (la main est invisible), _[illusion mineure]()_  
1/jour chacun : _[détection des pensées](), [dissipation de la magie](), [invisibilité](é), [image majeure]()_  
A|**Souffle désorientant (Recharge 5-6)**.  
B|**Changement de forme**.  
B|**Foulée psychique**.  
L|**Griffes**.  
L|**Psioniques (coûte 2 actions)**.  
...
\[ Ancient Emerald Dragon \] \[ Dragon d'émeraude, vénérable \]

Dragon (diamantin) de taille Gig, typiquement loyal neutre
...
Dragon (diamantin) de taille M, typiquement loyal neutre
...
Dragon (diamantin) de taille G, typiquement loyal neutre
...
A|**Queue**. +14, 4,50 m, 2d8+8 contondants  
A|**Présence terrifiante**.  
A|**Souffle de combat (Recharge 5-6)**.  
A|**Souffle de feu**.  
...
\[ Ancient Gold Dragon \] \[ Dragon d'or, vénérable \]
...
\[ Ancient Bronze Dragon \] \[ Dragon de bronze, vénérable \]
...
Dragon (diamantin) de taille TG, typiquement chaotique neutre
...
A|**Incantation (psioniques)**.  
À volonté : _[lumières dansantes](), [assistance]()_  
1/jour chacun : _[injonction](), [divination](), [motif hypnotique](), [restauration partielle]()_  
A|**Souffle scintillant (Recharge 5-6)**.  
B|**Changement de forme**.  
B|**Foulée psychique**.  
L|**Griffes**.  
L|**Psioniques (coûte 2 actions)**.  
...
\[ Ancient Crystal Dragon \] \[ Dragon de cristal, vénérable \]

Dragon (diamantin) de taille Gig, typiquement chaotique neutre
...
Dragon (diamantin) de taille G, typiquement chaotique neutre
...
\[ Ancient Copper Dragon \] \[ Dragon de cuivre, vénérable \]
...
A|**Queue**. +15, 6 m, 2d8+8 contondants  
A|**Présence terrifiante**.  
A|**Souffle de combat (Recharge 5-6)**.  
A|**Souffle d'acide**.  
A|**Souffle de ralentissement**.  
...
A|**Griffes**. +11, 1,50 m, 1d8+6 tranchants  
A|**Incantation (psioniques)**.  
1/jour chacun : _[murmures dissonants](), [immobilisation de monstre](), [fusion dans la pierre](), [télékinésie]()_  
A|**Souffle débilitant (Recharge 5-6)**.  
B|**Changement de forme**.  
B|**Foulée psychique**.  
L|**Griffes**.  
L|**Psioniques (coûte 2 actions)**.  
...
\[ Ancient Sapphire Dragon \] \[ Dragon de saphir, vénérable \]
...
**Résistance légendaire (3/jour)**.  
A|**Attaques multiples**.  
A|**Morsure**. +9, 3 m, 2d10+4 perforants  
A|**Griffes**. +9, 1,50 m, 1d8+4 tranchants  
A|**Incantation (psioniques)**.  
1/jour chacun : _[fléau](), [contrôle de l'eau](), [création ou destruction d'eau](-eau),_  
A|**Souffle desséchant (Recharge 5-6)**.  
B|**Changement de forme**.  
B|**Foulée psychique**.  
L|**Griffes**.  
L|**Psioniques (coûte 2 actions)**.  
...
\[ Ancient Topaz Dragon \] \[ Dragon de topaze, vénérable \]
...
Dragon de taille TG, typiquement neutre mauvais
...
A|**Queue**. +9, 4,50 m, 1d8+5 contondants  
A|**Changement de forme**.  
A|**Souffle de cauchemar (Recharge 5-6)**.  
...
\[ Ancient Deep Dragon \] \[ Dragon des profondeurs, vénérable \]

Dragon de taille Gig, typiquement neutre mauvais
...
Dragon de taille G, typiquement neutre mauvais
...
**Immunités** acide, froid, nécrotique, poison  
**Immunités** charmé, épuisement, effrayé, agrippé, paralysé, pétrifié, empoisonné, à terre, entravé  
**Sens** vision aveugle 18 m, vision dans le noir 36 m, Perception passive 24  
**Langues** commun, draconique, télépathie 36 m  
**Puissance** 17 (18000 PX) **Bonus de maîtrise** +6
...
**Résistance à la magie**.  
**Incantation innée**.  
Rouge (200 XP), 1/jour chacun : _[lumières dansantes](), [main de mage](), [illusion mineure]()_  
Orange (200 XP), 1/jour : _[couleurs dansantes]()_  
Jaune (200 XP), 1/jour : _[image miroir]()_  
Vert (450 XP), 1/jour : _[suggestion]()_  
Bleu (450 XP), 1/jour : _[image majeure]()_  
Indigo (450 XP), 1/jour : _[terrain hallucinatoire]()_  
Violet (450 XP), 1/jour : _[métamorphose]()_  
A|**Morsure**.  
...
\[ Ancient Black Dragon \] \[ Dragon noir, vénérable \]
...
A|**Griffes**. +10, 1,50 m, 2d6+5 tranchants  
A|**Queue**. +10, 4,50 m, 1d8+5 contondants  
A|**Souffle (Recharge 5-6)**.  
A|**Souffle de rêve**.  
A|**Souffle de lune**.  
A|**Incantation**.  
À volonté : _[lueurs féeriques]()_  
1/jour chacun : _[apaisement des émotions](), [invisibilité](é), [retour à la vie]()_  
L|**Queue**.  
...
\[ Ancient Moonstone Dragon \] \[ Dragon pierre-de-lune, vénérable \]

Dragon de taille Gig, typiquement neutre
...
\[ Ancient Red Dragon \] \[ Dragon rouge, vénérable \]
...
\[ Ancient Dragon Turtle \] \[ Dragon-tortue, vénérable \]
...
\[ Dragon Turtle Wyrmling \] \[ Dragonnet-tortue \]
...
\[ Ancient Green Dragon \] \[ Dragon vert, vénérable \]
...
A|**Attaques multiples**.  
A|**Morsure**. +15, 4,50 m, 2d10+8 perforants  
A|**Griffes**. +15, 3 m, 4d6+8 tranchants  
A|**Queue**. +15, 6 m, 2d8+8 contondants  
A|**Présence terrifiante**.  
A|**Souffle empoisonné (Recharge 5-6)**.  
L|**Détection**.  
...
Humanoïde de taille G, typiquement loyal bon
...
Humanoïde de taille G, typiquement chaotique mauvais
...
1/jour chacun : _[ténèbres](), [lueurs féeriques]()_  
**Pattes d'araignée**.  
**Sensibilité au soleil**.  
**Déplacement sur la toile**.  
A|**Attaques multiples**.  
...
Humanoïde (elfe) de taille M, typiquement chaotique mauvais
...
Humanoïde (elfe) de taille M, tout alignement
...
**Incantation innée**.  
À volonté : _[lumières dansantes]()_  
1/jour chacun : _[ténèbres](), [lueurs féeriques](), [lévitation]()_ (personnel uniquement)  
**Sensibilité au soleil**.  
A|**Attaques multiples**.  
A|**Cimeterre**. +8, 1,50 m, 1d6+4 tranchants  
A|**Fouet**. +8, 3 m, 1d4+4 tranchants  
A|**Arbalète de poing**. +8, 9/36 m, 1d6+4 perforants  
R|**Parade**.  
...
**Classe d'armure** 15 (18 avec _[armure de mage]()_)  
**Points de vie** 225 (30d8 + 90)  
**Vitesse** 9 m
...
**Sensibilité au soleil**.  
A|**Attaques multiples**.  
A|**Épée courte**. +7, 1,50 m, 1d6+4 perforants  
A|**Arbalète de poing**. +7, 9/36 m, 1d6+4 perforants  
R|**Parade**.  
...
Humanoïde (elfe, clerc) de taille M, typiquement neutre mauvais
...
**Ascendance féerique**.  
**Incantation innée**.  
À volonté : _[lumières dansantes](), [détection de la magie]()_  
1/jour chacun : _[clairvoyance](), [ténèbres](), [détection des pensées](), [dissipation de la magie](), [lueurs féeriques](), [lévitation]()_ (personnel uniquement), _[suggestion]()_  
**Résistance à la magie**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[assistance](), [message](), [bouffée de poison](), [résistance](), [thaumaturgie]()_  
Niv 1 (4) : _[soins](), [blessure](), [fléau]()_  
Niv 2 (3) : _[cécité/surdité](), [silence](), [arme spirituelle]()_  
Niv 3 (3) : _[malédiction](), [dissipation de la magie](), [cercle magique]()_  
Niv 4 (3) : _[bannissement](), [divination](), [liberté de mouvement]()_  
Niv 5 (2) : _[contagion](), [dissipation du mal et du bien](-du-bien), [fléau d'insectes]()_  
Niv 6 (1) : _[vision suprême](), [contamination]()_  
**Sensibilité au soleil**.  
A|**Attaques multiples**.  
...
1/jour chacun : _[ténèbres](), [lueurs féeriques](), [lévitation]()_ (personnel uniquement)  
**Incantation**.  
Sorts mineurs (à volonté) : _[main de mage](), [illusion mineure](), [bouffée de poison](), [rayon de givre]()_  
Niv 1 (4) : _[armure de mage](), [projectile magique](), [bouclier](), [trait ensorcelé]()_  
Niv 2 (3) : _[modification d'apparence](), [foulée brumeuse](), [toile d'araignée]()_  
Niv 3 (3) : _[vol](), [éclair]()_  
Niv 4 (3) : _[tentacules noirs d'Evard](), [invisibilité supérieure]()_  
Niv 5 (2) : _[brume mortelle]()_  
**Sensibilité au soleil**.  
A|**Bâton**.  
...
1/jour chacun : _[ténèbres](), [lueurs féeriques](), [lévitation]()_ (personnel uniquement)  
**Incantation**.  
Sorts mineurs (à volonté) : _[assistance](), [thaumaturgie](), [bouffée de poison](), [stabilisation](), [résistance]()_  
Niv 1 (4) : _[amitié avec les animaux](), [soins](), [détection du poison et des maladies](-des-maladies), [rayon empoisonné]()_  
Niv 2 (3) : _[restauration partielle](), [protection contre le poison](), [toile d'araignée]()_  
Niv 3 (3) : _[invocation d'animaux]()_ (2 araignées géantes), _[dissipation de la magie]()_  
Niv 4 (3) : _[divination](), [liberté de mouvement]()_  
Niv 5 (2) : _[fléau d'insectes](), [soins de groupe]()_  
**Sensibilité au soleil**.  
A|**Attaques multiples**.  
A|**Fouet barbelé**. +5, 1,50 m, 1d6+2 perforants  
A|**Invocation de démon (1/jour)**.  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[druidisme](), [flammes](), [gourdin magique]()_  
Niv 1 (4) : _[enchevêtrement](), [grande foulée](), [communication avec les animaux](), [vague tonnante]()_  
Niv 2 (3) : _[messager animal](), [peau d'écorce]()_  
...
Sorts mineurs (à volonté) : _[druidisme](), [assistance](), [résistance]()_  
Niv 1 (4) : _[amitié avec les animaux](), [nappe de brouillard](), [communication avec les animaux]()_  
Niv 2 (3) : _[messager animal](), [rayon de lune](), [passage sans trace]()_  
Niv 3 (3) : _[invocation d'animaux](), [tempête de neige](), [mur de vent]()_  
Niv 4 (3) : _[terrain hallucinatoire](), [tempête de grêle]()_  
Niv 5 (1) : _[éveil]()_  
A|**Attaques multiples**.  
...
**Incantation innée**.  
À volonté : _[druidisme]()_  
3/jour chacun : _[enchevêtrement](), [baies nourricières]()_  
1/jour chacun : _[peau d'écorce](), [passage sans trace](), [gourdin magique]()_  
**Résistance à la magie**.  
...
À volonté : _[main de mage](), [illusion mineure]()_  
1/jour chacun : _[contresort](), [foulée brumeuse](), [nuage nauséabond]()_  
**Résistance à la magie**.  
**Moteur psychique**.  
**Sensibilité au soleil**.  
A|**Attaques multiples**.  
...
\[ Duergar Warlord \] \[ Duergar, chef de guerre \]
...
A|**Javeline**. +7, 1,50 m ou 9/36 m, 1d6+4 perforants  
A|**Ordre d'attaquer**.  
A|**Agrandissement (Recharge après un repos court ou long)**.  
A|**Invisibilité (Recharge 4-6)**.  
...
**Résistances** acide, feu ; contondant, perforant et tranchant d'attaques non magiques  
**Immunités** froid, nécrotique, poison, psychique  
...
3/jour chacun : _[agrandissement/rapetissement](), [don des langues]()_  
1/jour chacun : _[changement de plan](), [invocation d'élémentaire]()_ (élémentaire du feu uniquement), _[forme gazeuse](), [image majeure](), [invisibilité](), [mur de feu]()_  
A|**Attaques multiples**.  
...
Élémentaire de l'air, myrmidon legacy
=====================================
...
Élémentaire de l'eau, myrmidon legacy
=====================================
...
**Incantation**.  
Sorts mineurs (à volonté) : _[amis](), [aspersion d'acide](), [lumière]()_  
Niv 1 (2) : _[bouclier](), [graisse](), [repli expéditif]()_  
A|**Dague**. +2, 1,50 m ou 6/18 m, 1d4 perforants  
...
**Incantation innée**.  
À volonté : _[restauration supérieure](), [passage sans trace](), [respiration aquatique](), [marche sur l'eau]()_  
1/jour chacun : _[communion](), [dissipation du mal et du bien](-du-bien), [tremblement de terre](), [tempête de feu](), [changement de plan]()_ (personnel uniquement)  
**Résistance légendaire (3/jour)**.  
**Résistance à la magie**.  
**Armes magiques**.  
A|**Maillet**.  
A|**Foudre**. +15, 180 m, 7d6 l  
L|**Attaque**.  
L|**Soutien**.  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[amis](), [main de mage](), [réparation](), [message]()_  
Niv 1 (4) : _[charme-personne]()\*, [armure de mage](), [projectile magique]()_  
Niv 2 (3) : _[immobilisation de personne]()\*, [invisibilité](), [suggestion]()\*_  
Niv 3 (3) : _[boule de feu](), [hâte](), [don des langues]()_  
Niv 4 (3) : _[domination de bête]()\*, [peau de pierre]()_  
Niv 5 (2) : _[immobilisation de monstre]()_  
...
Spasmes d'agonie (démon uniquement).  
...
Aura purulente (putréfié uniquement).  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[main de mage](), [message](), [prestidigitation]()_  
Niv 1 (4) : _[détection de la magie](), [protection contre le mal et le bien](-et-le-bien), [bouclier](), [rayon empoisonné]()_ (voir "Actions" ci-dessous)  
Niv 2 (3) : _[ténèbres](), [foulée brumeuse]()_  
A|**Attaques multiples**.  
...
Monstruosité de taille M, typiquement chaotique neutre
...
**Incantation**.  
Sorts mineurs (à volonté) : _[trait de feu]()\*, [lumière]()\*, [prestidigitation](), [rayon de givre]()\*_  
Niv 1 (4) : _[mains brûlantes]()\*, [armure de mage](), [projectile magique]()\*_  
Niv 2 (3) : _[image miroir](), [foulée brumeuse](), [fracassement]()\*_  
Niv 3 (3) : _[contresort](), [boule de feu]()\*, [éclair]()\*_  
Niv 4 (3) : _[tempête de grêle]()\*, [peau de pierre]()_  
Niv 5 (2) : _[main de Bigby]()\*, [cône de froid]()\*_  
Niv 6 (1) : _[chaîne d'éclairs]()\*, [mur de glace]()\*_  
\* sort d'évocation  
**Façonneur de sorts**.  
A|**Bâton**.  
...
• La cible doit réussir un jet de sauvegarde de Dextérité DD 13 ou être jetée à terre.  
...
\[ Cult Fanatic \] \[ Fanatique de secte \]
...
**Incantation**.  
Sorts mineurs (à volonté) : _[flamme sacrée](), [lumière](), [thaumaturgie]()_  
Niv 1 (4) : _[blessure](), [bouclier de la foi](), [injonction]()_  
Niv 2 (3) : _[arme spirituelle](), [immobilisation de personne]()_  
A|**Attaques multiples**.  
A|**Dague**. +4, 1,50 m ou 6/18 m, 1d4+2 perforants  
...
**Aura de meurtre**.  
**Incantation innée**.  
1/jour chacun: _[charme-personne](), [déguisement](), [sanctuaire]()_  
A|**Attaques multiples**.  
A|**Dague**. +7, 1,50 m ou 6/18 m, 1d4+5 perforants  
A|**Linceul**.  
...
**Incantation innée (psioniques)**.  
À volonté : _[détection des pensées](), [lévitation]()_  
1/jour chacun : _[domination de monstre](), [changement de plan]()_ (personnel uniquement)  
A|**Explosion de l'esprit (Recharge 5-6)**.  
...
Plante de taille G, typiquement chaotique mauvais
...
Plante de taille G, chaotique mauvais
...
Fiélon (gnoll) de taille M, typiquement chaotique mauvais
...
A|**Incantation**.  
À volonté : _[lumières dansantes](), [message](), [prestidigitation]()_  
...
**Vulnérabilité à l'électrocution**.  
A|**Attaques multiples**.  
A|**Tentacule**. +10, 6 m, 3d8+6 contondants  
A|**Morsure**. +10, 1,50 m, 3d10+6 perforants  
A|**Langue**.  
...
**Résistances** contondant, perforant et tranchant d'attaques non magiques  
**Immunités** poison  
**Immunités** épuisement, paralysé, empoisonné, pétrifié  
**Sens** vision dans le noir 18 m, perception des vibrations 18 m, Perception passive 11  
**Langues** terreux  
**Puissance** 6 (2300 PX)
...
**Apparence trompeuse**.  
**Charge en roulade**.  
A|**Coup**. +8, 1,50 m, 2d6+5 contondants  
...
**Aura de terreur**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[assistance](), [flamme sacrée](), [thaumaturgie]()_  
Niv 1 (4) : _[fléau]( ), [bénédiction]( ), [soins](), [éclair traçant]()_ (voir "Actions" ci-dessous)  
Niv 2 (3) : _[cécité/surdité](), [immobilisation de personne](), [silence]()_  
Niv 3 (2) : _[communication à distance](), [esprits gardiens]()_  
**Discipline tactique**.  
A|**Attaques multiples**.  
A|**Masse d'armes**. +7, 1,50 m, 1d6+4 contondants  
A|**Éclair traçant (sort de niveau 1 ; requiert un de sort)**. +7, 36 m, 4d6 radiants  
...
**Réservoir de sort**.  
A|**Attaques multiples**.  
A|**Poing**. +7, 1,50 m, 2d6+4 contondants  
R|**Bouclier**.  
...
**Immunités** poison  
**Immunités** épuisement, pétrifié, empoisonné  
**Sens** vision dans le noir 18 m, Perception passive 10  
**Langues** terreux  
**Puissance** 2 (450 PX)
...
**Odorat et ouïe aiguisés**.  
**Tactique de groupe**.  
A|**Morsure (forme de chacal ou hybride uniquement)**. +4, 1,50 m, 1d4+2 perforants  
A|**Cimeterre (forme humanoïde ou hybride uniquement)**. +4, 1,50 m, 1d6+2 tranchants  
...
**Regard étourdissant**.  
**Spasmes d'agonie**.  
A|**Morsure**. +6, 1,50 m, 2d8 perforants  
A|**Rayons oculaires**.  
A|**1- Rayon d'absorption de la magie**.  
A|**2- Rayon affaiblissant**.  
A|**3- Rayon répulsif**.  
A|**4- Rayon de feu**.  
A|**5- Rayon paralysant**.  
...
Aberration (tyrannoeil) de taille TP, typiquement neutre mauvais
...
A|**Morsure**.  
A|**Rayons oculaires**.  
A|**1- Rayon étourdissant**.  
A|**2- Rayon de la peur**.  
A|**3- Rayon de givre**.  
...
A|**Attaques multiples**.  
A|**Massue**. +8, 3 m, 3d8+5 contondants  
...
**Odorat aiguisé**.  
**Incantation innée**.  
À volonté : _[détection de la magie](), [nappe de brouillard](), [lumière]()_  
3/jour chacun : _[feuille morte](), [vol](), [foulée brumeuse](), [télékinésie]()_  
1/jour chacun : _[contrôle du climat](), [forme gazeuse]()_  
A|**Attaques multiples**.  
A|**Morgenstern**. +12, 3 m, 3d8+8 perforants  
...
Géant (géant des nuages) de taille TG, chaotique neutre
...
1/jour chacun : _[contrôle du climat](), [forme gazeuse]()_  
**Incantation**.  
Sorts mineurs (à volonté) : _[illusion mineure](), [prestidigitation](), [moquerie cruelle]()_  
Niv 1 (4) : _[soins](), [déguisement](), [image silencieuse](), [fou rire de Tasha]()_  
Niv 2 (3) : _[invisibilité](), [suggestion]()_  
Niv 3 (2) : _[image majeure](), [don des langues]()_  
**Odorat aiguisé**.  
A|**Attaques multiples**.  
A|**Morgenstern**. +12, 3 m, 3d8+8 contondants  
A|**Rocher**. +12, 18/72 m, 4d10+8 contondants  
A|**Changement de forme**.  
...
Géant (géant des pierres) de taille TG, chaotique neutre
...
**Charme d'onirien**.  
A|**Attaques multiples**.  
A|**Massue**. +10, 4,50 m, 3d8+6 contondants  
A|**Contact pétrifiant**.  
...
**Amphibien**.  
**Incantation innée**.  
À volonté : _[détection de la magie](), [feuille morte](), [lévitation](), [lumière]()_  
3/jour chacun : _[contrôle du climat](), [respiration aquatique]()_  
A|**Attaques multiples**.  
A|**Épée à deux mains**. +14, 3 m, 6d6+9 tranchants  
A|**Rocher**. +14, 18/72 m, 4d12+9 contondants  
...
**Amphibien**.  
A|**Attaques multiples**.  
A|**Épée de foudre**. +14, 4,50 m, 9d6+9 foudre  
A|**Javeline de vent**.  
L|**Rafale de vent**.  
L|**Foudre (2 actions)**.  
...
A|**Attaques multiples**.  
A|**Épée à deux mains**. +11, 3 m, 6d6+7 tranchants  
...
Géant de taille TG, typiquement loyal mauvais
...
Géant (géant du feu) de taille TG, loyal mauvais
...
A|**Attaques multiples**.  
A|**Bouclier de feu**.  
A|**Rocher**. +13, 18/72 m, 4d10+8 contondants  
...
A|**Attaques multiples**.  
A|**Hache à deux mains**. +9, 3 m, 3d12+6 tranchants  
A|**Rocher**. +9, 18/72 m, 4d10+6 contondants  
...
Géant de taille TG, typiquement chaotique mauvais
...
Géant (géant du givre) de taille TG, chaotique mauvais
...
**Rage de Vaprak (Recharge après un repos court ou long)**.  
A|**Attaques multiples**.  
A|**Hache à deux mains**. +11, 3 m, 3d12+7 tranchants  
A|**Rocher**. +11, 18/72 m, 4d10+7 contondants  
...
**Informe**.  
**Pattes d'araignée**.  
A|**Pseudopode**. +4, 1,50 m, 2d6+2 contondants  
R|**Division**.  
...
**Odorat aiguisé**.  
A|**Attaques multiples**.  
A|**Morsure**. +6, 1,50 m, 1d6+4 perforants  
...
**Incantation innée (psioniques)**.  
À volonté : _[main de mage]()_ (la main est invisible)  
3/jour chacun : _[saut](), [foulée brumeuse](), [antidétection]()_ (personnel uniquement), _[don des langues]()_  
1/jour chacun : _[changement de plan](), [télékinésie]()_  
A|**Attaques multiples**.  
...
Humanoïde (gith, magicien) de taille M, tout alignement
...
**Incantation innée (psioniques)**.  
À volonté : _[main de mage]()_ (la main est invisible)  
3/jour chacun : _[saut](), [foulée brumeuse](), [antidétection]()_ (personnel uniquement)  
A|**Attaques multiples**.  
...
**Incantation innée (psioniques)**.  
À volonté : _[main de mage]()_ (la main est invisible)  
3/jour chacun : _[feuille morte](), [saut](), [voir l'invisible](), [bouclier]()_  
**Défense psychique**.  
A|**Attaques multiples**.  
...
À volonté : _[main de mage]()_ (la main est invisible)  
3/jour chacun : _[feuille morte](), [saut](), [voir l'invisible](), [bouclier]()_  
1/jour chacun : _[assassin imaginaire](), [changement de plan]()_  
**Défense psychique**.  
A|**Attaques multiples**.  
...
**Incantation innée**.  
À volonté : _[ténèbres](), [détection de la magie](), [dissipation de la magie]()_  
1/jour chacun : _[confusion](), [vol](), [mot de pouvoir étourdissant]()_  
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Pinces**. +9, 3 m, 2d10+5 contondants  
...
**Brutal**.  
A|**Attaques multiples**.  
A|**Lance**. +7, 1,50 m ou 6/18 m, 2d6+4 perforants  
...
A|**Attaques multiples**.  
A|**Morsure**. +4, 1,50 m, 1d4+2 perforants  
A|**Gourdin**. +4, 1,50 m, 1d4+2 contondants  
R|**Frappe vengeresse**.  
...
**Ruse de gnome**.  
**Incantation innée**.  
À volonté : _[antidétection]()_ (personnel uniquement)  
1/jour chacun : _[cécité/surdité](), [flou](), [déguisement]()_  
A|**Pic de guerre**. +4, 1,50 m, 1d8+2 perforants  
...
**Attaque surprise**.  
**Brutal**.  
A|**Morgenstern**. +4, 1,50 m, 2d8+2 perforants  
...
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Coup**. +8, 1,50 m, 2d10+5 contondants  
A|**Hâte (Recharge 5-6)**.  
...
A|**Attaques multiples**.  
A|**Coup**. +10, 1,50 m, 3d8+5 contondants  
...
**Armes magiques**.  
A|**Attaques multiples**.  
A|**Coup**. +13, 1,50 m, 3d8+7 contondants  
A|**Épée**. +13, 3 m, 3d10+7 tranchants  
...
**Armes magiques**.  
A|**Attaques multiples**.  
A|**Coup**. +6, 1,50 m, 3d10+5 contondants  
...
**Armes magiques**.  
A|**Attaques multiples**.  
A|**Coup**. +10, 1,50 m, 3d8+6 contondants  
...
**Charge écrasante**.  
A|**Corne**. +8, 1,50 m, 2d12+5 perforants  
A|**Sabots**. +8, 1,50 m, 2d10+5 contondants  
...
**Monstre de siège**.  
A|**Attaques multiples**.  
A|**Poing**. +13, 3 m, 3d8+7 contondants  
...
Dragon (chromatique) de taille Gig, typiquement chaotique mauvais
...
**Immunités** acide (noir), froid (blanc), feu (rouge), foudre (bleu) ou poison (vert)  
**Immunités** charmé, effrayé, empoisonné  
...
**Immunités** force (améthyste), nécrotique (topaze), psychique (émeraude), radiant (cristal) ou tonerre (saphir)  
...
Griffes.  
Souffle (Recharge 5-6).  
Télékinésie de groupe (Éveil des gemmes seulement ; Recharge après un repos court ou long).  
Incantation (psioniques).  
Changement de forme.  
Foulée psychique.  
Griffes.  
...
Dragon (métallique) de taille Gig, typiquement loyal bon
...
**Immunités** acide (cuivre), froid (argent), feu (airain et or) ou foudre (bronze)  
**Immunités** charmé, effrayé, empoisonné  
**Sens** vision véritable 36 m, Perception passive 32  
**Langues** commun, draconique  
**Puissance** 28 (120000 PX) **Bonus de maîtrise** +8
...
A|**Attaques multiples**.  
A|**Poing**. +5, 1,50 m, 1d6+3 contondants  
...
Résistance à la magie.  
Attaques multiples.  
Lame de chagrin (épée à deux mains).  
Incantation.  
Téléportation.  
Métamorphe.  
...
**Métamorphe**.  
**Incantation innée**.  
À volonté : _[charme-personne](), [couronne du dément](), [détection de la magie](), [dissipation de la magie](), [murmures dissonants]()_  
3/jour chacun : _[contresort](), [ténèbres](), [domination de personne](), [sanctuaire](), [télékinésie](), [téléportation]()_  
1/jour chacun : _[domination de monstre](), [invisibilité supérieure]()_  
**Résistance légendaire (3/jour)**.  
**Résistance à la magie**.  
**Armes magiques**.  
A|**Attaques multiples**.  
A|**Lame de chagrin (épée à deux mains)**. +13, 3 m, 4d6+6 tranchants  
A|**Téléportation**.  
L|**Attaque**.  
L|**Danse, ma marionnette**.  
L|**Graine de la discorde**.  
L|**Téléportation**.  
...
**Camouflage dans les rochers**.  
A|**Attaques multiples**.  
A|**Tentacules**. +4, 1,50 m, 2d6+2 tranchants  
...
**Vue aiguisée**.  
A|**Attaques multiples**.  
A|**Bec**. +6, 1,50 m, 1d8+4 perforants  
...
**Saut sans élan**.  
**Incantation**.  
Niv 1 (4) : _[soins](), [saut]()_  
Niv 2 (3) : _[peau d'écorce](), [croissance d'épines]()_  
Niv 3 (2) : _[croissance végétale]()_  
A|**Dague**. +5, 1,50 m ou 6/18 m, 1d4+3 perforants  
A|**Arc court**. +5, 24/96 m, 1d6+3 perforants  
...
**Incantation innée**.  
3/jour chacun : _[déguisement]()_ (peut prendre la forme d'un humanoïde de taille M), _[nappe de brouillard]()_  
A|**Attaques multiples**.  
A|**Morsure**. +8, 1,50 m, 3d6+5 perforants  
A|**Griffes**. +8, 1,50 m, 3d6+5 tranchants  
...
Fée de taille M, typiquement chaotique mauvais
...
**Marche sur la glace**.  
**Incantation innée**.  
À volonté : _[immobilisation de personne]()\*, [rayon de givre]()_  
3/jour chacun : _[cône de froid]()\*, [tempête de grêle]()\*, [mur de glace]()\*_  
1/jour chacun : _[contrôle du climat]()_  
A|**Coup**. +4, 1,50 m, 2d8+1 contondants  
A|**Festin oppressant**.  
...
**Incantation innée**.  
À volonté : _[détection de la magie](), [projectile magique]()_  
2/jour chacun : _[changement de plan]()_ (personnel uniquement), _[rayon affaiblissant](), [sommeil]()_  
**Résistance à la magie**.  
A|**Griffes (forme de guenaude uniquement)**. +7, 1,50 m, 2d8+4 tranchants  
A|**Changement de forme**.  
A|**Passage dans l'éther**.  
...
**Amphibien**.  
**Incantation innée**.  
À volonté : _[lumières dansantes](), [illusion mineure](), [moquerie cruelle]()_  
**Imitation**.  
A|**Griffes**. +6, 1,50 m, 2d8+4 tranchants  
A|**Apparence illusoire**.  
A|**Passage invisible**.  
...
**Armes magiques**.  
A|**Attaques multiples**.  
A|**Dard**. +7, 1,50 m, 1d8+4 perforants  
A|**Serres-lames**. +7, 1,50 m, 2d6+4 perforants  
...
Géant (géant des collines) de taille TG, chaotique mauvais
...
**Armes magiques**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[illusion mineure](), [main de mage](), [prestidigitation]()_  
Niv 1 (4) : _[bouclier](), [détection de la magie](), [identification]()_  
Niv 2 (3) : _[localisation d'objet](), [ténèbres](), [suggestion]()_  
Niv 3 (3) : _[délivrance des malédictions](), [dissipation de la magie](), [don des langues]()_  
Niv 4 (3) : _[bannissement](), [invisibilité supérieure]()_  
Niv 5 (1) : _[Mythes et légendes]()_  
A|**Attaques multiples**.  
A|**Griffes**. +8, 1,50 m, 2d8+4 tranchants  
L|**Attaque avec les griffes**.  
L|**Téléportation (coûte 2 actions)**.  
L|**Sort (coûte 3 actions)**.  
...
**Classe d'armure** 14 (17 avec _[armure de mage]()_)  
...
**Résistances** feu et foudre (conférée par le _sceptre d'explosions_)  
**Sens** vision dans le noir 36 m, Perception passive 21  
...
Reconstitution.  
Résistance légendaire (3/jour).  
Restauration magique (1/jour).  
Sceptre d'explosions.  
Lancer un sort.  
Sort de préservation (coûte 2 actions).  
...
A|**Attaques multiples**.  
A|**Griffes**. +3, 1,50 m, 2d4+1 tranchants  
A|**Gourdin**. +3, 1,50 m, 1d4+1 contondants  
A|**Chant captivant**.  
...
Hurlement psychique (forme hybride uniquement ; Recharge après un repos court ou long).  
Métamorphe.  
...
**Amphibien (forme hybride uniquement)**.  
A|**Attaques multiples**.  
A|**Hache d'armes (forme humanoïde uniquement)**. +6, 1,50 m, 1d8+4 tranchants  
A|**Morsure (forme hybride uniquement)**. +6, 1,50 m, 1d4+4 perforants  
A|**Griffes (forme hybride uniquement)**. +6, 1,50 m, 1d6+4 tranchants  
...
**Vue aiguisée**.  
A|**Attaques multiples**.  
A|**Bec**. +5, 1,50 m, 1d10+3 perforants  
A|**Griffes**. +5, 1,50 m, 2d6+3 tranchants  
...
**Avantage martial**.  
A|**Attaques multiples**.  
A|**Épée à deux mains**. +4, 1,50 m, 2d6+2 perforants  
A|**Javeline**. +4, 1,50 m ou 9/36 m, 1d6+2 perforants  
A|**Commandement (Recharge après un repos court ou long)**.  
...
**Arcanes de l'armée**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[aspersion d'acide](), [trait de feu](), [rayon de givre](), [poigne électrique]()_  
Niv 1 (4) : _[nappe de brouillard](), [projectile magique](), [vague tonnante]()_  
Niv 2 (3) : _[bourrasque](), [flèche acide de Melf](), [rayon ardent]()_  
Niv 3 (3) : _[boule de feu](), [vol](), [éclair]()_  
Niv 4 (1) : _[tempête de grêle]()_  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[illusion mineure](), [prestidigitation](), [coup au but]()_  
Niv 1 (3) : _[charme-personne](), [déguisement](), [repli expéditif](), [image silencieuse]()_  
**Défense sans armure**.  
A|**Attaques multiples**.  
A|**Attaque à mains nues**. +5, 1,50 m, 1d4+3 contondants  
A|**Fléchette**. +5, 6/18 m, 1d4+3 perforants  
...
**Avantage martial**.  
A|**Attaques multiples**.  
A|**Épée longue**. +9, 1,50 m, 1d8+3 tranchants  
A|**Coup de bouclier**. +9, 1,50 m, 1d4+3 contondants  
A|**Javeline**. +9, 1,50 m ou 9/36 m, 1d6+3 perforants  
A|**Commandement (Recharge après un repos court ou long)**.  
R|**Parade**.  
...
A|**Attaques multiples**.  
A|**Morsure**. +4, 1,50 m, 1d6+2 perforants  
A|**Gourdin lesté**. +4, 1,50 m, 1d6+2 contondants  
A|**Javeline**. +4, 1,50 m ou 9/36 m, 1d6+2 perforants  
...
Sorts mineurs (à volonté) : _[druidisme](), [flammes](), [fouet épineux]()_  
Niv 1 (4) : _[enchevêtrement](), [nappe de brouillard]()_  
Niv 2 (3) : _[métal brûlant](), [croissance d'épines]()_  
Niv 3 (2) : _[invocation d'animaux]()_ (reptiles uniquement), _[croissance végétale]()_  
A|**Attaques multiples (forme d'homme-lézard uniquement)**.  
A|**Morsure**. +4, 1,50 m, 1d6+2 perforants  
A|**Griffes (forme d'homme-lézard uniquement)**. +4, 1,50 m, 1d4+2 tranchants  
...
**Compétences** Perception +4  
**Résistances** contondant, perforant et tranchant d'attaques non magiques qui ne sont pas en adamantium  
**Immunités** force, nécrotique, poison  
**Immunités** aveuglé, charmé, assourdi, effrayé, paralysé, pétrifié, empoisonné, étourdi  
**Sens** vision aveugle 18 m (aveugle au-delà de ce rayon), Perception passive 14  
**Langues** comprend les langues de son créateur mais ne peut pas parler  
**Puissance** 4 (1100 PX)
...
**Brutal**.  
A|**Attaques multiples**.  
A|**Épée longue +1**. +8, 1,50 m, 2d8+5 tranchants  
A|**Coup de bouclier**. +7, 1,50 m, 2d4+4 contondants  
...
Fée de taille M (magicien), chaotique neutre
...
**Incantation**.  
Sorts mineurs (à volonté) : _[lumières dansantes](), [main de mage](), [illusion mineure](), [bouffée de poison]()_  
Niv 1 (4) : _[couleurs dansantes]()\*, [déguisement]()\*, [armure de mage](), [projectile magique]()_  
Niv 2 (3) : _[invisibilité]()\*, [image miroir]()\*, [force fantasmagorique]()\*_  
Niv 3 (3) : _[image majeure]()\*, [monture fantôme]()\*_  
Niv 4 (1) : _[assassin imaginaire]()\*_  
...
**Résistances** contondant, perforant et tranchant d'attaques non magiques  
**Immunités** feu, poison  
**Immunités** charmé, effrayé, paralysé, pétrifié, empoisonné, à terre, entravé  
**Sens** vision aveugle 36 m, Perception passive 13  
**Langues** commun, igné  
**Puissance** 19 (22000 PX)
...
Sorts mineurs (à volonté) : _[assistance](), [flamme sacrée]()_  
Niv 1 (2) : _[soins]()_  
**Incantation (mage)**.  
Sorts mineurs (à volonté) : _[lumière](), [trait de feu]()_  
Niv 1 (2) : _[sommeil]()_  
...
**Incantation (guérisseur)**.  
Sorts mineurs (à volonté) : _[assistance](), [flamme sacrée]()_  
Niv 1 (2) : _[bénédiction]( ), [soins]()_  
**Incantation (mage)**.  
Sorts mineurs (à volonté) : _[lumière](), [trait de feu]()_  
Niv 1 (2) : _[mains brûlantes](), [sommeil]()_  
A|**Bâton**. +2, 1,50 m, 1d6 contondants  
...
**Incantation (guérisseur)**.  
Sorts mineurs (à volonté) : _[assistance](), [flamme sacrée]()_  
Niv 1 (3) : _[bénédiction]( ), [bouclier de la foi](), [soins]()_  
**Incantation (mage)**.  
Sorts mineurs (à volonté) : _[lumière](), [trait de feu]()_  
Niv 1 (3) : _[bouclier](), [mains brûlantes](), [sommeil]()_  
A|**Bâton**. +2, 1,50 m, 1d6 contondants  
...
**Rôle magique**.  
**Incantation (guérisseur)**.  
Sorts mineurs (à volonté) : _[assistance](), [flamme sacrée](), [résistance]()_  
Niv 1 (3) : _[bénédiction]( ), [bouclier de la foi](), [soins]()_  
**Incantation (mage)**.  
Sorts mineurs (à volonté) : _[lumière](), [main de mage](), [trait de feu]()_  
Niv 1 (3) : _[bouclier](), [mains brûlantes](), [sommeil]()_  
A|**Bâton**. +2, 1,50 m, 1d6 contondants  
...
**Incantation (guérisseur)**.  
Sorts mineurs (à volonté) : _[assistance](), [flamme sacrée](), [résistance]()_  
Niv 1 (4) : _[bénédiction]( ), [bouclier de la foi](), [soins]()_  
Niv 2 (2) : _[aide]()_  
**Incantation (mage)**.  
Sorts mineurs (à volonté) : _[lumière](), [main de mage](), [trait de feu]()_  
Niv 1 (4) : _[bouclier](), [mains brûlantes](), [sommeil]()_  
Niv 2 (2) : _[invisibilité]()_  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[aspersion d'acide](), [main de mage](), [bouffée de poison](), [prestidigitation]()_  
Niv 1 (4) : _[armure de mage](), [projectile magique](), [serviteur invisible]()\*_  
Niv 2 (3) : _[nuée de dagues]()\*, [foulée brumeuse]()\*, [toile d'araignée]()\*_  
Niv 3 (3) : _[boule de feu](), [nuage nauséabond]()\*_  
Niv 4 (3) : _[tentacules noirs d'Evard]()\*, [peau de pierre]()_  
Niv 5 (2) : _[brume mortelle]()\*, [invocation d'élémentaire]()\*_  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[flamme sacrée](), [lumière](), [stabilisation]()_  
Niv 1 (4) : _[bouclier de la foi](), [détection du mal et du bien](-du-bien), [éclair traçant](), [soins]()_  
Niv 2 (3) : _[arme spirituelle](), [restauration partielle]()_  
Niv 3 (3) : _[cercle magique](), [esprits gardiens]()_  
A|**Épée longue**.  
...
Humanoïde (elfe) de taille M, chaotique neutre
...
Céleste de taille TG, typiquement loyal bon
...
**Incantation innée**.  
À volonté : _[forme gazeuse](), [image majeure]()_ (lancé au niveau 6), _[marche sur le vent]()_  
1/jour : _[création de nourriture et d'eau](-d-eau)_  
**Résistance légendaire (3/jour)**.  
**Résistance à la magie**.  
**Armes magiques**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[lumière](), [réparation](), [flamme sacrée](), [stabilisation](), [thaumaturgie]()_  
Niv 1 (4) : _[injonction](), [soins](), [détection du mal et du bien](-du-bien), [protection contre le mal et le bien](-et-le-bien), [sanctuaire]()_  
Niv 2 (3) : _[apaisement des émotions](), [restauration partielle](), [silence]()_  
Niv 3 (3) : _[dissipation de la magie](), [délivrance des malédictions](), [communication à distance]()_  
Niv 4 (3) : _[bannissement](), [liberté de mouvement](), [gardien de la foi]()_  
Niv 5 (3) : _[restauration supérieure](), [soins de groupe](), [scrutation]()_  
Niv 6 (1) : _[festin des héros](), [vision suprême]()_  
Niv 7 (1) : _[forme éthérée](), [changement de plan]()_  
Niv 8 (1) : _[contrôle du climat]()_  
Niv 9 (1) : _[résurrection suprême]()_  
A|**Attaques multiples**.  
A|**Sabot**. +9, 4,50 m, 2d4+5 contondants  
A|**Corne**. +9, 1,50 m, 2d8+5 perforants  
L|**Détection**.  
L|**Châtiment**.  
L|**Déplacement**.  
...
**Sensibilité au soleil**.  
**Tactique de groupe**.  
A|**Dague**. +5, 1,50 m, 1d4+3 perforants  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[trait de feu](), [main de mage](), [réparation](), [bouffée de poison]()_  
Niv 1 (4) : _[charme-personne](), [orbe chromatique](), [repli expéditif]()_  
Niv 2 (2) : _[rayon ardent]()_  
...
A|**Dague**. +4, 1,50 m ou 6/18 m, 1d4+2 perforants  
A|**Fronde**. +4, 9/36 m, 1d4+2 contondants  
A|**Invention militaire**.  
A|**1- Acide**. +4, 1,50/6 m, 2d6 acide  
A|**2- Feu grégeois**. +4, 1,50/6 m, 1d4 feu  
A|**3- Soulier de mille-pattes**.  
A|**4- Pot de vase verte**.  
A|**5- Pot de vers des charniers**.  
A|**6- Scorpion sur une canne**.  
A|**7- Putois en cage**.  
...
**Corde de cheveux**.  
**Incantation innée**.  
À volonté : _[communion avec la nature](), [fusion dans la pierre](), [façonnage de la pierre]()_  
1/jour chacun : _[invocation d'élémentaire]()_ (comme un sort de niveau 6 ; galeb duhr, gargouille, élémentaire de terre ou xorn uniquement), _[danse irrésistible d'Otto]()_  
**Camouflage dans les rochers**.  
**Force de la pierre**.  
A|**Attaques multiples**.  
A|**Massue**. +9, 1,50 m, 1d8+6 contondants  
...
**Monstre de siège**.  
A|**Attaques multiples**.  
A|**Morsure**. +17, 1,50 m, 3d8+10 perforants  
A|**Tentacule**. +17, 9 m, 3d6+10 contondants  
A|**Catapultage**.  
A|**Tempête d'éclairs**.  
L|**Attaque de tentacule ou Catapultage**.  
L|**Tempête d'éclairs (coûte 2 actions)**.  
...
\[ Young Kruthik \] \[ Kruthik, immature \]
...
**Incantation**.  
Sorts mineurs (à volonté) : _[assistance](), [flamme sacrée](), [thaumaturgie]()_  
Niv 1 (4) : _[détection de la magie](), [sanctuaire](), [bouclier de la foi]()_  
Niv 2 (3) : _[immobilisation de personne](), [arme spirituelle]()_  
Niv 3 (3) : _[esprits gardiens](), [don des langues]()_  
Niv 4 (3) : _[contrôle de l'eau](), [divination]()_  
Niv 5 (2) : _[scrutation](), [soins de groupe]()_  
A|**Attaques multiples**.  
A|**Sceptre**. +6, 1,50 m, 1d6+3 contondants  
...
**Sensibilité au soleil**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[flamme sacrée](), [thaumaturgie]()_  
Niv 1 (3) : _[bouclier de la foi](), [fléau]()_  
A|**Attaques multiples**.  
A|**Morsure**. +4, 1,50 m, 1d4+2 perforants  
...
**Classe d'armure** 18 (_[robe de l'archimage]()_)  
...
**Résistance à la magie**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[lumière](), [main de mage](), [illusion mineure](), [](), [rayon de givre]()_  
Niv 1 (à volonté) : _[détection de la magie](), [déguisement](), [projectile magique](), bouclier_  
Niv 2 (à volonté) : _[détection des pensées](), [invisibilité](), [foulée brumeuse]()_  
Niv 3 (3) : _[contresort](), [vol](), [communication à distance](), langues_  
Niv 4 (3) : _[bannissement](), [invisibilité supérieure](), [sphère résiliente d'Otiluke]()_  
Niv 5 (3) : _[cône de froid](), [quête](), [lien télépathique de Rary]()_  
Niv 6 (2) : _[globe d'invulnérabilité](), [suggestion de groupe]()_  
Niv 7 (1) : _[rayons prismatiques](), [téléportation]()_  
Niv 8 (1) : _[esprit faible](), [mot de pouvoir étourdissant]()_  
Niv 9 (1) : _[arrêt du temps]()_  
A|**Attaques multiples**.  
A|**Cheveux d'argent**. +11, 1,50 m, 2d6 force  
A|**Épée ardente**. +7, 1,50 m, 1d8+1 tranchants  
A|**Feu-sorcier (Recharge après un repos long)**.  
Tant que les flammes argentées sont présentes, elle peut effectuer les actions suivantes :  
...
\[ Sword Wraith Warrior \] \[ Lame-en-peine, soldat \]
...
**Incantation innée**.  
À volonté : _[déguisement]()_ (n'importe quelle forme humanoïde), _[image majeure]()_  
3/jour : _[charme-personne](), [image miroir](), [scrutation](), [suggestion]()_  
1/jour : _[quête]()_  
A|**Attaques multiples**.  
A|**Griffes**. +5, 1,50 m, 2d10+3 tranchants  
A|**Dague**. +5, 1,50 m, 1d4+3 perforants  
A|**Contact enivrant**.  
...
**Incantation innée**.  
À volonté : _[amitié avec les animaux]()_ (serpents uniquement)  
3/jour chacun : _[suggestion](), [bouffée de poison]()_  
**Amulette du rêveur**.  
2/jour chacun : _[couronne du dément](), [rayon empoisonné](), [sommeil]()_  
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Cimeterre**. +3, 1,50 m, 1d6+1 tranchants  
A|**Arc court**. +3, 24/96 m, 1d6+1 perforants  
...
Monstruosité de taille G, typiquement chaotique mauvais
...
Élémentaire de taille Gig, neutre
...
**Reconstitution**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[main de mage](), [prestidigitation](), [rayon de givre]()_  
Niv 1 (4) : _[détection de la magie](), [projectile magique](), [bouclier](), [vague tonnante]()_  
Niv 2 (3) : _[détection des pensées](), [invisibilité](), [flèche acide de Melf](), [image miroir]()_  
Niv 3 (3) : _[animation des morts](), [contresort](), [dissipation de la magie](), [boule de feu]()_  
Niv 4 (3) : _[flétrissement](), [porte dimensionnelle]()_  
Niv 5 (3) : _[brume mortelle](), [scrutation]()_  
Niv 6 (1) : _[désintégration](), [globe d'invulnérabilité]()_  
Niv 7 (1) : _[doigt de mort](), [changement de plan]()_  
Niv 8 (1) : _[domination de monstre](), [mot de pouvoir étourdissant]()_  
Niv 9 (1) : _[mot de pouvoir mortel]()_  
**Résistance au renvoi**.  
A|**Contact paralysant**. +12, 1,50 m, 3d6 froid  
L|**Sort mineur**.  
L|**Contact paralysant (coûte 2 actions)**.  
L|**Regard effrayant (coûte 2 actions)**.  
...
**Charge**.  
**Incantation innée**.  
À volonté : _[détection du mal et du bien](-du-bien), [druidisme](), [passage sans trace]()_  
1/jour chacun : _[apaisement des émotions](), [enchevêtrement](), [dissipation du mal et du bien](-du-bien)_  
**Résistance à la magie**.  
**Armes magiques**.  
A|**Attaques multiples**.  
A|**Sabots**. +7, 1,50 m, 2d6+4 contondants  
A|**Corne**. +7, 1,50 m, 1d8+4 perforants  
A|**Contact guérisseur (3/jour)**.  
A|**Téléportation (1/jour)**.  
L|**Sabots**.  
L|**Boucliers scintillant (coûte 2 actions)**.  
...
**Apparence trompeuse**.  
**Régénération**.  
A|**Contact**. +3, 1,50 m, 3d8 psychiques  
A|**Musc jaune (3/jour)**.  
...
**Odorat et ouïe aiguisés**.  
A|**Attaques multiples (forme humanoïde ou hybride uniquement)**.  
A|**Morsure (forme de loup ou hybride uniquement)**. +4, 1,50 m, 1d8+2 perforants  
A|**Griffes (forme hybride uniquement)**. +4, 1,50 m, 2d4+2 tranchants  
...
Artificiel de taille TG, typiquement loyal mauvais
...
**Incantation**.  
Sorts mineurs (à volonté) : _[trait de feu](), [lumière](), [main de mage](), [prestidigitation]()_  
Niv 1 (4) : _[armure de mage](), [bouclier](), [détection de la magie](), [projectile magique]()_  
Niv 2 (3) : _[foulée brumeuse](), [suggestion]()_  
Niv 3 (3) : _[boule de feu](), [contresort](), [vol]()_  
Niv 4 (3) : _[invisibilité supérieure](), [tempête de grêle]()_  
Niv 5 (1) : _[cône de froid]()_  
A|**Dague**. +5, 1,50 m ou 6/18 m, 1d4+2 perforants  
...
**Magie de la tombe**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[contact glacial]()_ (voir "Actions" ci-dessous), _[main de mage](), [message](), [prestidigitation]()_  
Niv 1 (4) : _[mains brûlantes](), [détection de la magie](), [rayon empoisonné]()_ (voir "Actions" ci-dessous), _[bouclier]()_  
Niv 2 (3) : _[ténèbres](), [foulée brumeuse](), [rayon ardent]()_ (voir "Actions" ci-dessous)  
Niv 3 (2) : _[animation des morts](), [boule de feu]()_  
A|**Attaques multiples**.  
A|**Fléau de crâne en argent**. +2, 1,50 m, 1d8 contondants  
A|**Contact glacial (sort mineur)**. +6, 36 m, 2d8 nécrotiques  
A|**Rayon empoisonné (sort de niveau 1 ; requiert un de sort)**. +6, 18 m, 2d8 poison  
A|**Rayon ardent (sort de niveau 2 ; requiert un de sort)**. +6, 36 m, 2d6 feu  
...
A|**Attaques multiples**.  
A|**Épée courte**. +7, 1,50 m, 1d6+4 perforants  
A|**Arc court**. +7, 24/96 m, 1d6+4 perforants  
B|**Action fourbe**.  
R|**Esquive**.  
...
A|**Attaques multiples**.  
A|**Épée courte**. +7, 1,50 m, 1d6+4 perforants  
A|**Arbalète légère**. +7, 24/96 m, 1d8+4 perforants  
R|**Esquive**.  
...
Humanoïde (demi-elfe) de taille M, neutre mauvais
...
**Équipement spécial**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[coup au but](), [lumière](), [main de mage](), [trait de feu]()_  
Niv 1 (4) : _[armure de mage](), [compréhension des langues]()\*, [détection de la magie]()\*, [feuille morte]()_  
Niv 2 (3) : _[localisation d'objet]()\*, [rayon ardent](), [ténèbres]()_  
Niv 3 (3) : _[boule de feu](), [clairvoyance]()\*, [vol]()_  
Niv 4 (1) : _[tempête de grêle]()_  
\* sort de divination de niveau 1 ou supérieur  
...
**Tactique de groupe**.  
A|**Attaques multiples**.  
A|**Masse d'armes**. +4, 1,50 m, 1d6+2 contondants  
A|**Arbalète lourde**. +2, 30/120 m, 1d10 perforants  
...
**Charge écrasante**.  
A|**Défenses**. +10, 3 m, 4d8+7 perforants  
...
**Classe d'armure** 19 (_[robe de l'archimage](), bâton de puissance_)  
...
**Écholocalisation**.  
**Apparence trompeuse**.  
A|**Écrasement**. +5, 1,50 m, 1d6+3 contondants  
...
**Sensibilité à la lumière**.  
A|**Attaques multiples**.  
A|**Morsure**. +6, 1,50 m, 2d6+3 perforants  
A|**Queue**. +6, 3 m, 1d8+3 tranchants  
A|**Gémissement**.  
...
**Disparition élémentaire**.  
**Incantation innée**.  
À volonté : _[création ou destruction d'eau](-eau), [détection du mal et du bien](-du-bien), [détection de la magie](), [nappe de brouillard](), purification de nourriture et d'eau_  
3/jour chacun : _[don des langues](), [respiration aquatique](), [marche sur l'eau]()_  
1/jour chacun : _[invocation d'élémentaire]()_ (élémentaire de l'eau uniquement), _[contrôle de l'eau](), [forme gazeuse](), [invisibilité](), [changement de plan]()_  
A|**Attaques multiples**.  
...
**Réactif**.  
A|**Attaques multiples**.  
A|**Épée longue**. +9, 1,50 m, 2d8+4 tranchants  
A|**Queue**. +9, 3 m, 2d10+4 contondants  
A|**Téléportation**.  
R|**Parade**.  
...
Artificiel (inévitable) de taille G, typiquement loyal neutre
...
**Résistances** tonnerre ; contondant, perforant et tranchant d'attaques non magiques  
**Immunités** poison  
...
**Fouisseur**.  
A|**Attaques multiples**.  
A|**Griffes**. +8, 1,50 m, 1d8+5 tranchants  
...
**Regard pétrifiant**.  
A|**Attaques multiples**.  
A|**Chevelure venimeuse**. +5, 1,50 m, 1d4+2 perforants  
A|**Épée courte**. +5, 1,50 m, 1d6+2 perforants  
...
**Mort explosive**.  
**Apparence trompeuse**.  
A|**Poing**. +3, 1,50 m, 1d6+1 contondants  
...
**Mort explosive**.  
**Incantation innée (1/jour)**.  
A|**Griffes**. +2, 1,50 m, 1d4 tranchants  
...
**Amphibien**.  
A|**Attaques multiples**.  
A|**Griffes**. +6, 1,50 m, 2d4+4 tranchants  
A|**Morsure**. +6, 1,50 m, 1d8+4 perforants  
...
**Classe d'armure** 14 (avec _[armure de mage]()_)  
...
**Équipement spécial**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[amis](), [aspersion d'acide](), [lumière](), [bouffée de poison]()_  
Niv 1 (4) : _[armure de mage](), [trait ensorcelé](), [projectile magique](), [sommeil]()_  
Niv 2 (3) : _[flèche acide de Melf](), [sphère de feu](), [vision dans le noir]()_  
...
**Incantation innée**.  
2/jour chacun : _[ténèbres](), [dissipation de la magie]()_  
1/jour : _[brume mortelle]()_  
**Résistance à la magie**.  
**Armes magiques**.  
A|**Attaques multiples**.  
A|**Griffes**. +7, 1,50 m, 2d4+4 tranchants  
A|**Trident**. +7, 1,50 m ou 6/18 m, 1d6+4 perforants  
A|**Téléportation**.  
...
**Résistances** acide, feu, foudre, tonnerre  
**Immunités** froid, nécrotique, poison  
...
**Lutteur**.  
A|**Pseudopode**. +5, 1,50 m, 1d8+3 contondants  
A|**Morsure**. +5, 1,50 m, 1d8+3 perforants  
...
**Mémoire de labyrinthe**.  
**Téméraire**.  
A|**Hache à deux mains**. +6, 1,50 m, 2d12+4 tranchants  
...
**Incantation innée**.  
À volonté : _[modification d'apparence]()_ (peut être de catégorie de taille M lorsqu'il change d'apparence), _[animation des morts](), [mains brûlantes]()_ (lancé comme un sort de niveau 7), _[confusion](), [détection de la magie](), [vol](), [quête](), [image majeure](), [nuage nauséabond](), [suggestion](), [mur de feu]()_  
1/jour chacun : _[colonne de flamme](), [symbole]()_ (étourdissant uniquement)  
**Résistance légendaire (3/jour)**.  
**Résistance à la magie**.  
**Armes magiques**.  
**Régénération**.  
A|**Attaques multiples**.  
A|**Morsure**. +15, 1,50 m, 4d8+8 perforants  
A|**Griffes**. +15, 3 m, 2d8+8 tranchants  
A|**Fouet aux innombrables queues**. +15, 9 m, 2d4+8 tranchants  
A|**Souffle du désespoir (Recharge 5-6)**.  
A|**Téléportation**.  
L|**Nuage nauséabond**.  
L|**Téléportation**.  
L|**Fouet**.  
...
\[ Shadow Mastiff Alpha \] \[ Molosse des ombres alpha \]
...
A|**Attaques multiples**.  
A|**Poings putréfiants**. +5, 1,50 m, 2d6+3 contondants  
...
**Amphibien**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[aspersion d'acide](), [main de mage](), [réparation](), [rayon de givre](), [poigne électrique]()_  
Niv 1 (4) : _[détection de la magie](), [identification](), [bouclier](), [trait ensorcelé]()_  
Niv 2 (3) : _[ténèbres](), [détection des pensées](), [fracassement]()_  
Niv 3 (3) : _[dissipation de la magie](), [éclair](), [communication à distance]()_  
Niv 4 (3) : _[porte dimensionnelle](), [tentacules noirs d'Evard]()_  
Niv 5 (3) : _[quête](), [scrutation]()_  
Niv 6 (1) : _[chaîne d'éclairs]()_  
A|**Attaques multiples**.  
A|**Morsure**. +6, 1,50 m, 2d6+2 tranchants  
A|**Tentacules**. +6, 1,50 m, 3d8+2 contondants  
A|**Hypnose**.  
R|**Renvoi de sort**.  
...
**Apnée**.  
A|**Défenses**. +4, 1,50 m, 2d4+2 perforants  
...
**Apnée**.  
A|**Attaques multiples**.  
A|**Coup de corps**. +8, 1,50 m, 2d8+6 contondants  
A|**Défenses**. +8, 1,50 m, 3d6+6 perforants  
...
**Spores de détresse**.  
**Maladie solaire**.  
A|**Poing**. +2, 1,50 m, 2d4 contondants  
...
**Maladie solaire**.  
A|**Attaques multiples**.  
A|**Poing**. +3, 1,50 m, 3d4+1 contondants  
A|**Spores réanimatrices (3/jour)**.  
A|**Spores hallucinogènes**.  
...
**Reconstitution**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[main de mage](), [illusion mineure](), [rayon de givre]()_  
Niv 1 (4) : _[charme-personne](), [détection de la magie](), [sommeil]()_  
Niv 2 (3) : _[détection des pensées](), [immobilisation de personne]()_  
Niv 3 (3) : _[éclair](), [respiration aquatique]()_  
Niv 4 (3) : _[flétrissement](), [porte dimensionnelle]()_  
Niv 5 (2) : _[domination de personne]()_  
...
Monstruosité de taille G, loyal bon
...
**Reconstitution**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[réparation](), [flamme sacrée](), [thaumaturgie]()_  
Niv 1 (4) : _[injonction](), [soins](), [bouclier de la foi]()_  
Niv 2 (3) : _[apaisement des émotions](), [immobilisation de personne]()_  
Niv 3 (3) : _[malédiction](), [clairvoyance]()_  
Niv 4 (3) : _[bannissement](), [liberté de mouvement]()_  
Niv 5 (2) : _[colonne de flamme](), [quête]()_  
Niv 6 (1) : _[vision suprême]()_  
A|**Morsure**. +8, 3 m, 1d8+4 perforants  
...
Sorts mineurs (à volonté) : _[réparation](), [flamme sacrée](), [thaumaturgie]()_  
Niv 1 (4) : _[injonction](), [bouclier de la foi]()_  
Niv 2 (3) : _[apaisement des émotions](), [immobilisation de personne]()_  
Niv 3 (2) : _[malédiction]()_  
...
Sorts mineurs (à volonté) : _[main de mage](), [illusion mineure](), [rayon de givre]()_  
Niv 1 (4) : _[charme-personne](), [sommeil]()_  
Niv 2 (3) : _[détection des pensées](), [immobilisation de personne]()_  
Niv 3 (2) : _[éclair]()_  
...
Humanoïde (nagpa) de taille M, neutre mauvais
...
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Griffes**. +10, 3 m, 3d6+5 tranchants  
A|**Morsure**. +10, 1,50 m, 5d10+5 perforants  
A|**Nimbe d'horreur (Recharge 5-6)**.  
A|**Téléportation**.  
...
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Lance d'arçon des feux de l'enfer**. +10, 3 m, 1d12+5 perforants  
A|**Commandement infernal**.  
A|**Commandement terrifiant**.  
A|**Guérison (1/jour)**.  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[contact-glacial](), [lumières dansantes](), [main de mage](), [réparation]()_  
Niv 1 (4) : _[simulacre de vie]()\*, [armure de mage](), [rayon empoisonné]()\*_  
Niv 2 (3) : _[cécité/surdité]()\*, [rayon affaiblissant]()\*, [toile d'araignée]()_  
Niv 3 (3) : _[animation des morts]()\*, [malédiction]()\*, [toucher du vampire]()\*_  
Niv 4 (3) : _[flétrissement]()\*, [porte dimensionnelle](), [peau de pierre]()_  
Niv 5 (2) : _[main de Bigby](), [brume mortelle]()_  
Niv 6 (1) : _[cercle de mort]()\*_  
\* sort de nécromancie de niveau 1 ou supérieur  
**Sinistre moisson (1/tour)**.  
A|**Toucher flétrissant**. +7, 1,50 m, 2d4 nécrotiques  
...
A|**Fléau de crâne**. +2, 1,50 m, 1d8 contondants  
A|**Griffes de la tombe**. +5, 27 m, 2d4+3 nécrotiques  
...
**Sensibilité au soleil**.  
A|**Attaques multiples**.  
A|**Absorption de vie**. +4, 1,50 m, 1d6+2 nécrotiques  
A|**Épée longue**. +4, 1,50 m, 1d8+2 tranchants  
A|**Arc long**. +4, 45/180 m, 1d8+2 perforants  
...
Aberration de taille P, typiquement loyal mauvais
...
Aberration de taille TP, typiquement loyal mauvais
...
A|**Attaques multiples**.  
A|**Morsure**. +5, 1,50 m, 1d6+3 perforants  
A|**Griffes**. +5, 1,50 m, 2d4+3 tranchants  
...
Aberration (occultiste) de taille M, typiquement loyal mauvais
...
**Sauvegardes** Sag +3  
**Compétences** Arcanes +5, Tromperie +6, Intimidation +6, Perception +3, Persuasion +6  
**Sens** vision dans le noir 36 m (traverse les ténèbres magiques), Perception passive 13  
**Langues** commun, profond, commun des profondeurs, télépathie 9 m  
**Puissance** 4 (1100 PX)
...
**Pattes d'araignée**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[décharge occulte]()_ (portée 90 mètres, bonus de +4 à chaque jet de dégâts), _[assistance](), [main de mage](), [illusion mineure](), [prestidigitation](), [moquerie cruelle]()_  
Nivx 1-4 (2 de niveau 4) : _[tentacules de Hadar](), [contresort](), [porte dimensionnelle](), [peur](), [immobilisation de personne](), [voracité de Hadar](), [invisibilité](), [serviteur invisible]()_  
A|**Attaques multiples**.  
A|**Morsure**. +5, 1,50 m, 1d6+3 perforants  
A|**Griffes**. +5, 1,50 m, 2d4+3 tranchants  
A|**Asservissement (Recharge après un repos court ou long)**.  
...
**Perception des créatures**.  
**Incantation innée (psioniques)**.  
À volonté : _[lévitation]()_  
1/jour chacun : _[confusion](), [esprit faible](), [télékinésie]()_  
**Résistance à la magie**.  
A|**Tentacules**. +13, 4,50 m, 3d8+8 contondants  
A|**Souffle d'acide (Recharge 5-6)**.  
...
Fée (gobelinoïde) de taille P, typiquement chaotique neutre
...
**Incantation innée**.  
À volonté : _[main de mage](), [fou rire de Tasha](), [moquerie cruelle]()_  
1/jour : _[confusion]()_  
**Nilebogisme**.  
**Fuite agile**.  
A|**Sceptre du sot**. +4, 1,50 m, 1d6+2 contondants  
A|**Arc court**. +4, 24/96 m, 1d6+2 perforants  
R|**Revers de fortune**.  
...
A|**Rapière**. +3, 1,50 m, 1d8+1 perforants  
R|**Parade**.  
...
**Vue aiguisée**.  
A|**Attaques multiples**.  
A|**Griffes**. +4, 1,50 m, 1d6+3 tranchants  
...
Nuée de bêtes TP de taille M, loyal mauvais
...
**Éclairage**.  
**Incantation innée (psioniques)**.  
À volonté : _[injonction](), [compréhension des langues](), [détection des pensées]()_  
1/jour chacun : _[confusion](), [domination de monstre]()_  
**Nuée**.  
**Voile télépathique**.  
...
**Incantation innée**.  
À volonté : _[ténèbres](), [détection de la magie](), [dissipation de la magie](), [invisibilité]()_ (personnel uniquement), _[image miroir]()_  
**Résistance à la magie**.  
**Armes magiques**.  
A|**Attaques multiples**.  
A|**Griffes**. +9, 1,50 m, 2d6+5 tranchants  
A|**Hache à deux mains**. +9, 1,50 m, 2d12+5 tranchants  
A|**Téléportation**.  
...
Artificiel de taille G ou plus petite, -
...
Vase de taille M, loyal mauvais
...
Vase de taille TP, loyal mauvais
...
**Classe d'armure** 13 (16 avec _[armure de mage]()_)  
**Points de vie** 67 (15d8)  
**Vitesse** 9 m
...
A|**Attaques multiples**.  
A|**Rapière**. +5, , 1d8+3 perforants  
A|**Mot déconcertant**.  
A|**Incantation**.  
À volonté : _[lumières dansantes](), [déguisement](), [armure de mage]()_ (personnel uniquement), _[main de mage](), [illusion mineure](), [prestidigitation](), [communication avec les animaux]()_  
1/jour chacun : _[charme-personne](), [porte dimensionnelle](), [immobilisation de monstre]()_  
...
**Classe d'armure** 11 (14 avec _[armure de mage]()_)  
**Points de vie** 49 (11d8)  
**Vitesse** 9 m
...
**Incantation innée**.  
À volonté : _[déguisement](), [armure de mage]()_ (personnel uniquement), _[image silencieuse](), [communication avec les animaux]()_  
1/jour : _[invocation de fée]()_  
**Incantation**.  
Sorts mineurs (à volonté) : _[décharge occulte](), [amis](), [lumières dansantes](), [main de mage](), [illusion mineure](), [prestidigitation](), [moquerie cruelle]()_  
Niv 1-5 (3 de niveau 5) : _[clignotement](), [charme-personne](), [porte dimensionnelle](), [domination de bête](), [lueurs féeriques](), [peur](), [immobilisation de monstre](), [foulée brumeuse](), [force fantasmagorique](), [sommeil](), [apparence trompeuse]()_  
...
A|**Attaques multiples**.  
A|**Cimeterre**. +6, , 1d6+3 contondants  
A|**Feu de l'enfer**.  
A|**Incantation**.  
À volonté : _[modification d'apparence](), [armure de mage]()_ (personnel uniquement), _[main de mage](), [illusion mineure](), [prestidigitation]()_  
1/jour chacun : _[bannissement](), a href="">changement de plan, [suggestion]()_  
...
**Sauvegardes** Sag +4, Cha +7  
**Compétences** Arcanes +4, Persuasion +7, Religion +4, Tromperie +7  
**Résistances** tranchant d'attaques non magiques qui ne sont pas en argent  
**Sens** vision dans le noir 18 m, Perception passive 11  
**Langues** deux langues au choix (généralement abyssal ou infernal)  
**Puissance** 7 (2900 PX)

**Incantation innée**.  
À volonté : _[modification d'apparence](), [simulacre de vie](), [lévitation]() (personnel uniquement), [armure de mage]() (personnel uniquement), [image silencieuse]()_  
1/jour chacun : _[esprit faible](), [doigt de mort](), [changement de plan]()_  
**Incantation**.  
Sorts mineurs (à volonté) : _[décharge occulte](), [trait de feu](), [amis](), [main de mage](), [illusion mineure](), [prestidigitation](), [poigne électrique]()_  
Nivx 1 à 5 (4 de niveau 5) : _[bannissement](), [mains brûlantes](), [colonne de flamme](), [représailles infernales](), [cercle magique](), [rayon ardent](), [scrutation](), [nuage nauséabond](), [suggestion](), [mur de feu]()_  
**Chance du ténébreux (Recharge après un repos court ou long)**.  
...
A|**Vide hurlant**.  
A|**Incantation**.  
À volonté : _[détection de la magie](), assistance, [lévitation](), [armure de mage]()_ (personnel uniquement), _[main de mage](), [illusion mineure](), [prestidigitation](), [communication avec les morts]()_  
1/jour chacun : _[portail magique](), [détection des pensées](), [vision suprême]()_  
...
**Incantation innée**.  
À volonté : _[détection de la magie](), [saut](), [lévitation](), [armure de mage]()_ (personnel uniquement), _[communication avec les morts]()_  
1/jour chacun : _[vision suprême](), [portail magique]()_  
**Incantation**.  
Sorts mineurs (à volonté) : _[contact glacial](), [décharge occulte](), [assistance](), [main de mage](), [illusion mineure](), [prestidigitation](), [poigne électrique]()_  
Niv 1-5 (3 de niveau 5) : _[armure d'Agathys](), [tentacules de Hadar](), [couronne du dément](), [clairvoyance](), [contact avec un autre plan](-plan), [détection des pensées](), [porte dimensionnelle](), [murmures dissonants](), [domination de bête](), [télékinésie](), [toucher du vampire]()_  
**Aura chuchotante**.  
A|**Dague**. +5, 1,50 m ou 6/18 m, 1d4+2 perforants  
...
A|**Massue**. +6, 1,50 m, 2d8+4 contondants  
...
**Résistances** contondant, perforant et tranchant d'attaques non magiques  
**Immunités** poison  
**Immunités** charmé, effrayé, paralysé, pétrifié, empoisonné, à terre  
**Sens** vision aveugle 36 m, perception des vibrations 36 m, Perception passive 12  
...
**Incantation innée**.  
À volonté : _[ténèbres](), [invisibilité]()_  
1/jour chacun : _[charme-personne](), [cône de froid](), [forme gazeuse](), [sommeil]()_  
**Armes magiques**.  
**Régénération**.  
A|**Attaques multiples**.  
A|**Griffes (forme d'oni uniquement)**. +7, 1,50 m, 1d8+4 tranchants  
A|**Coutille**. +7, 3 m, 2d10+4 tranchants  
A|**Changement de forme**.  
...
**Vision de Shargaas**.  
**Tueur**.  
A|**Cimeterre**. +5, 1,50 m, 3d6+3 tranchants  
A|**Fléchette**. +5, 6/18 m, 3d4+3 perforants  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[assistance](), [réparation](), [résistance](), [thaumaturgie]()_  
Niv 1 (4) : _[fléau](), [soins](), [éclair traçant]()_  
Niv 2 (3) : _[augure](), [lien de protection]()_  
Niv 3 (2) : _[malédiction](), [création de nourriture et d'eau](-d-eau)_  
A|**Attaques multiples**.  
...
A|**Attaques multiples**.  
A|**Épée longue**. +5, 1,50 m, 2d8+3 tranchants  
A|**Javeline**. +5, 1,50 m ou 9/36 m, 1d6+3 perforants  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[assistance](), [réparation](), [résistance](), [thaumaturgie]()_  
Niv 1 (4) : _[fléau](), [détection de la magie](), [blessure](), [protection contre le mal et le bien](-et-le-bien)_  
Niv 2 (3) : _[cécité/surdité](), [silence]()_  
...
**Furie de Gruumsh**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[assistance](), [résistance](), [thaumaturgie]()_  
Niv 1 (4) : _[bénédiction](), [injonction]()_  
Niv 2 (2) : _[augure](), [arme spirituelle]()_ (lance)  
A|**Lance**.  
...
**Résistances** froid, feu, foudre  
**Immunités** nécrotique, poison ; contondant, perforant et tranchant non magiques  
**Immunités** charmé, épuisement, effrayé, empoisonné  
**Sens** vision véritable 36 m, Perception passive 22  
**Langues** toutes, télépathie 36 m  
**Puissance** 26 (90000 PX) **Bonus de maîtrise** +8
...
**Baguette d'Orcus**.  
**Incantation innée**.  
À volonté : _[contact glacial]()_ (niveau 17), _[détection de la magie]()_  
3/jour chacun : _[création de mort-vivant](), [dissipation de la magie]()_  
1/jour : _[arrêt du temps]()_  
**Résistance légendaire (3/jour)**.  
**Résistance à la magie**.  
**Armes magiques**.  
**Maître des morts-vivants**.  
A|**Attaques multiples**.  
A|**Baguette d'Orcus**. +19, 3 m, 3d8+8 contondants  
A|**Queue**. +17, 3 m, 3d8+8 perforants  
L|**Queue**.  
L|**Un avant-goût de la non-mort**.  
...
**Agressif**.  
A|**Attaques multiples**.  
A|**Hache à deux mains**. +6, 1,50 m, 1d12+4 tranchants  
A|**Javeline**. +6, 1,50 m ou 9/36 m, 1d6+4 perforants  
...
Fiélon (diable) de taille G, typiquement loyal mauvais
...
**Télépathie limitée**.  
A|**Attaques multiples**.  
A|**Morsure**. +6, 1,50 m, 2d8+3 perforants  
A|**Tentacule**. +6, 3 m, 1d8+3 contondants  
...
**Odorat aiguisé**.  
A|**Attaques multiples**.  
A|**Morsure (forme d'ours ou hybride uniquement)**. +7, 1,50 m, 2d10+4 perforants  
A|**Griffes (forme d'ours ou hybride uniquement)**. +7, 1,50 m, 2d8+4 tranchants  
...
A|**Attaques multiples**.  
A|**Bec**. +7, 1,50 m, 1d10+5 perforants  
...
**Odorat aiguisé**.  
A|**Attaques multiples**.  
A|**Griffes**. +7, 1,50 m, 2d6+5 tranchants  
...
**Odorat ferreux**.  
**Oxydation**.  
A|**Morsure**. +3, 1,50 m, 1d8+1 perforants  
A|**Antennes**.  
...
Artificiel de taille M, typiquement loyal mauvais
...
**Camouflage dans l'eau**.  
**Respiration aquatique**.  
A|**Tentacules**. +5, 4,50 m, 2d6+3 contondants  
...
**Incantation innée**.  
À volonté : _[druidisme]()_  
1/jour chacun : _[confusion](), [lumières dansantes](), [détection du mal et du bien](-du-bien), [détection des pensées](), [dissipation de la magie](), [enchevêtrement](), [vol](), [force fantasmagorique](), [métamorphose](), [sommeil]()_  
...
**Conscience divine**.  
**Incantation innée**.  
À volonté : _[détection du mal et du bien](-du-bien), [invisibilité]()_ (personnel uniquement)  
3/jour chacun : _[barrière de lames](), [colonne de flamme](), [dissipation du mal et du bien](-du-bien), [rappel à la vie]()_  
1/jour chacun : _[communion](), [contrôle du climat](), [fléau d'insectes]()_  
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Épée à deux mains**. +12, 1,50 m, 4d6+7 tranchants  
...
**Discipline tactique**.  
A|**Masse d'armes**. +5, 1,50 m, 1d6+3 contondants  
A|**Arc long**. +2, 45/180 m, 1d8 perforants  
...
**Forme corrosive**.  
**Pattes d'araignée**.  
A|**Pseudopode**. +5, 1,50 m, 1d6+3 contondants  
R|**Division**.  
...
**Immunités** poison, psychique ; contondant, perforant et tranchant d'attaques non magiques  
...
Fée de taille TP, typiquement chaotique mauvais
...
**Incantation**.  
Sorts mineurs (à volonté) : _[flamme sacrée](), [lumière](), [thaumaturgie]()_  
Niv 1 (4) : _[éclair traçant](), [sanctuaire](), [soins]()_  
Niv 2 (3) : _[arme spirituelle](), [restauration partielle]()_  
Niv 3 (2) : _[dissipation de la magie](), [esprits gardiens]()_  
...
A|**Feu sacré**.  
A|**Incantation**.  
À volonté : _[lumière](), [stabilisation](), [thaumaturgie]()_  
1/jour chacun : _[bannissement](), [injonction](), [dissipation de la magie](), [colonne de flamme](), [gardien de la foi](), [immobilisation de personne](), [restauration partielle](), [retour à la vie]()_  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[lumière](), [réparation](), [flamme sacrée](), [stabilisation]()_  
Niv 1 (4) : _[faveur divine](), [éclair traçant](), [mot de guérison](), [bouclier de la foi]()_  
Niv 2 (3) : _[restauration partielle](), [arme magique](), [prière de guérison](), [silence](), [arme spirituelle]()_  
Niv 3 (3) : _[lueur d'espoir](), [aura du croisé](), [dissipation de la magie](), [retour à la vie](), [esprits gardiens](), [marche sur l'eau]()_  
Niv 4 (3) : _[bannissement](), [liberté de mouvement](), [gardien de la foi](), [peau de pierre]()_  
Niv 5 (1) : _[colonne de flamme](), [soins de groupe](), [immobilisation de monstre]()_  
A|**Attaques multiples**.  
A|**Maillet**.  
...
**Amphibien**.  
A|**Attaques multiples**.  
A|**Contact tonitruant**. +5, 1,50 m, 5d10 tonnerre  
A|**Coup de tonnerre**. +5, , 2d10 foudre  
A|**Incantation innée**.  
À volonté : _[injonction](), [création ou destruction d'eau](-eau)_  
3/jour chacun : _[contrôle de l'eau](), [ténèbres](), [respiration aquatique](), [marche sur l'eau]()_  
1/jour : _[tentacules noirs d'Evard]()_  
...
À volonté : _[injonction](), [création ou destruction d'eau](-eau)_  
3/jour chacun : _[contrôle de l'eau](), [ténèbres](), [respiration aquatique](), [marche sur l'eau]()_  
1/jour chacun : _[appel de la foudre](), [tentacules noirs d'Evard]()_  
A|**Contact tonitruant**. +5, 1,50 m, 5d10 tonnerre  
A|**Voix du kraken (Recharge après un repos court ou long)**.  
...
**Résistance à la magie**.  
**Télépathie limitée**.  
A|**Morsure**. +4, 1,50 m, 1d4+2 tranchants  
...
**Métamorphe**.  
**Résistance à la magie**.  
A|**Griffes (Morsure sous forme de bête)**. +4, 1,50 m, 1d4+3 perforants  
A|**Frayeur (1/jour)**.  
A|**Invisibilité**.  
...
Bête (dinosaure) de taille TG, sans alignement
...
**Compétences** Perception +5  
**Immunités** feu, poison  
**Immunités** aveuglé, assourdi, effrayé, empoisonné  
...
A|**Attaques multiples**.  
A|**Liane diabolique**. +6, 3 m, 2d6+3 contondants  
...
**Immunités** contondant, perforant et tranchant d'attaques non magiques  
**Sens** vision dans le noir 18 m, Perception passive 13  
...
**Incantation innée**.  
À volonté : _[déguisement](), [détection des pensées](), [illusion mineure](), [main de mage]()_  
3/jour chacun : _[charme-personne](), [détection de la magie](), [image majeure](), [invisibilité](), [suggestion]()_  
1/jour chacun : _[changement de plan](), [domination de personne](), [vision suprême](), [vol]()_  
A|**Attaques multiples**.  
...
**Odorat aiguisé**.  
A|**Attaques multiples (forme humanoïde ou hybride uniquement)**.  
A|**Morsure (forme de rat ou hybride uniquement)**. +4, 1,50 m, 1d4+2 perforants  
A|**Épée courte (forme humanoïde ou hybride uniquement)**. +4, 1,50 m, 1d6+2 perforants  
...
**Amphibie limitée**.  
A|**Attaques multiples**.  
A|**Attaque à mains nues**. +4, 1,50 m, 1d4+2 contondants  
A|**Anatomie de poisson**.  
A|**Morsure**. +5, 1,50 m, 1d4+2 perforants  
A|**Épines empoisonnées**. +5, 1,50 m, 1d6 poison  
...
\[ Star Spawn Hulk \] \[ Fléau stellaire, colosse \]
...
\[ Star Spawn Grue \] \[ Fléau stellaire, frémisseur \]
...
Aberration de taille P, neutre mauvais
...
\[ Star Spawn Larva Mage \] \[ Fléau stellaire, magever \]
...
\[ Star Spawn Mangler \] \[ Fléau stellaire, massacreur \]
...
\[ Star Spawn Seer \] \[ Fléau stellaire, voyant \]
...
**Corps brûlant**.  
A|**Morsure**. +11, 3 m, 6d10+7 perforants  
A|**Engloutissement**.  
...
**Immunités** poison  
**Immunités** charmé, épuisement, effrayé, paralysé, empoisonné, étourdi  
**Sens** vision dans le noir 18 m, Perception passive 13  
**Langues** les langues qu'il connaissait de son vivant  
**Puissance** 5 (1800 PX)
...
A|**Attaques multiples**.  
A|**Morsure**. +5, 1,50 m, 1d6+3 perforants  
A|**Griffes**. +5, 1,50 m, 1d4+3 tranchants  
...
Bête (bétail) de taille M, sans alignement
...
**Classe d'armure** 10 (13 avec _[armure de mage]()_)  
**Points de vie** 22 (5d8)  
**Vitesse** 9 m
...
A|**Poigne électrique (sort mineur)**. +6, , 2d8 foudre  
A|**Incantation**.  
À volonté : _[lumière](), [main de mage](), [réparation]()_  
3/jour chacun : _[compréhension des langues](), [détection de la magie](), [identification]()_  
1/jour chacun : _[dissipation de la magie](), [lévitation](), [localisation d'objet](), voir l'invisible, communication à distance, don des langues, serviteur invisible_  
R|**Bouclier (sort de niveau 1 ; 3/jour)**.  
...
A|**Poigne électrique (sort mineur)**. +8, , 3d8 foudre  
A|**Boule de feu (sort de niveau 3 ; 3/jour)**.  
A|**Incantation**.  
À volonté : _[lumière](), [main de mage](), [réparation](), [prestidigitation]()_  
3/jour chacun : _[compréhension des langues](), [détection de la magie](), [dissipation de la magie](), [identification](), [lévitation](), [localisation d'objet](), disque flottant de Tenser, serviteur invisible_  
1/jour chacun : _[bannissement](), contact avec un autre plan, convocations instantanées de Drawmij, mythes et légendes, localisation de créature, contrat, métamorphose, [protection contre le mal et le bien](-et-le-bien), [scrutation](), communication à distance, [vision suprême]()_  
R|**Bouclier (sort de niveau 1 ; 3/jour)**.  
...
Humanoïde (sahuagin) de taille G, loyal mauvais
...
**Télépathie avec les requins**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[assistance](), [thaumaturgie]()_  
Niv 1 (4) : _[bénédiction](), [détection de la magie](), [éclair traçant]()_  
Niv 2 (3) : _[immobilisation de personne](), [arme spirituelle]()_ (trident)  
Niv 3 (3) : _[mot de guérison de groupe](-groupe), [don des langues]()_  
A|**Attaques multiples**.  
A|**Griffes**. +3, 1,50 m, 1d4+1 tranchants  
A|**Morsure**. +3, 1,50 m, 1d4+1 perforants  
...
A|**Attaques multiples (forme humanoïde ou hybride uniquement)**.  
A|**Maillet (forme humanoïde ou hybride uniquement)**. +5, 1,50 m, 2d6+3 contondants  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[lumière](), [protection contre les armes](), [poigne électrique]()_  
Niv 1 (4) : _[armure de mage](), [charme personne](), [projectile magique]()_  
Niv 2 (3) : _[foulée brumeuse](), [immobilisation de personne]()_  
A|**Bâton**.  
...
\[ Hoard Scarab \] \[ Scarabée de butin \]
...
A|**Attaques multiples**.  
A|**Pinces**. +4, 1,50 m, 1d8+2 contondants  
...
A|**Attaques multiples**.  
A|**Épée à deux mains**. +9, 1,50 m, 2d6+5 tranchants  
A|**Arc court**. +7, 24/96 m, 1d6+3 perforants  
L|**Commandement des alliés**.  
...
Mort-vivant (ensorceleur) de taille M, typiquement loyal mauvais
...
**Vulnérabilités** feu  
**Immunités** nécrotique, poison ; contondant, perforant et tranchant d'attaques non magiques  
**Immunités** charmé, épuisement, effrayé, paralysé, empoisonné  
**Sens** vision dans le noir 18 m, Perception passive 14  
**Langues** les langues qu'il connaissait de son vivant  
**Puissance** 15 (13000 PX)
...
**Incantation**.  
Sorts mineurs (à volonté) : _[flamme sacrée](), [thaumaturgie]()_  
Niv 1 (4) : _[bouclier de la foi](), [éclair traçant](), [injonction]()_  
Niv 2 (3) : _[arme spirituelle](), [immobilisation de personne](), [silence]()_  
Niv 3 (3) : _[animation des morts](), [dissipation de la magie]()_  
Niv 4 (3) : _[divination](), [gardien de la foi]()_  
Niv 5 (2) : _[contagion](), [fléau d'insectes]()_  
Niv 6 (1) : _[contamination]()_  
A|**Attaques multiples**.  
A|**Poings putréfiants**. +9, 1,50 m, 3d6+4 contondants  
A|**Regard d'épouvante**.  
L|**Attaques**.  
L|**Poussière aveuglante**.  
L|**Blasphème (coûte 2 actions)**.  
L|**Canalisation d'énergie négative (coûte 2 actions)**.  
...
Mort-vivant de taille M (paladin), loyal mauvais
...
Mot de mort (1/jour).  
Manœuvre implacable.  
Frappe (coûte 2 actions).  
Sort (coûte 3 actions).  
...
Humanoïde (humain, métamorphe) de taille M, chaotique neutre
...
A|**Attaques multiples (forme humanoïde ou hybride uniquement)**.  
A|**Morsure (forme de phoque ou hybride uniquement)**. +4, 1,50 m, 1d4+2 perforants  
A|**Épée courte (forme humanoïde ou hybride uniquement)**. +4, 1,50 m, 1d6+2 perforants  
A|**Arbalète de poing (forme humanoïde ou hybride uniquement)**. +4, 9/36 m, 1d6+2 perforants  
...
**Immunités** poison  
**Immunités** épuisement, agrippé, paralysé, empoisonné, entravé, à terre, inconscient  
**Sens** vision aveugle 9 m, Perception passive 10  
**Langues** comprend l'aquatique mais ne peut pas parler  
**Puissance** 3 (700 PX)
...
A|**Morsure**. +6, 3 m, 2d6+4 perforants  
...
\[ Ancient Sea Serpent \] \[ Serpent de mer, vénérable \]
...
**Compétences** Perception +9  
**Résistances** perforant, tranchant  
**Immunités** acide, contondant, froid, feu, fourdre, nécrotique, poison, psychique, radiant  
...
Artificiel de taille TP, sans alignement
...
A|**Coup**. +5, 1,50 m, 1d4 contondants  
...
**Compétences** Perception +7  
**Immunités** nécrotique, psychique  
**Immunités** charmé, épuisement, effrayé  
**Sens** vision dans le noir 18 m, Perception passive 17  
**Langues** commun, elfique  
**Puissance** 11 (7200 PX) **Bonus de maîtrise** +4
...
**Déchaîné**.  
A|**Attaques multiples**.  
A|**Morsure**. +7, 1,50 m, 4d10+4 perforants  
...
**Contamination**.  
**Incantation innée**.  
À volonté : _[charme-personne](), [injonction](), [dissipation de la magie](), [immobilisation de monstre]()_  
3/jour : _[esprit faible]()_  
**Résistance légendaire (3/jour)**.  
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Chaîne**. +6, 4,50 m, 2d12+7 perforants  
A|**Morsure**. +6, 1,50 m, 2d8 perforants  
A|**Crachat de bile**.  
A|**Corruption de créature**.  
L|**Sort**.  
L|**Vaporisation de bile**.  
...
A|**Attaques multiples**.  
A|**Poing**. +9, 3 m, 3d10+6 contondants  
...
Aberration (métamorphe) de taille M, chaotique mauvais
...
**Métamorphe**.  
**Incantation innée**.  
À volonté : _[détection de la magie](), [détection des pensées](), [invisibilité]()_ (personnel uniquement), _[main de mage](), [image majeure]()_  
2/jour chacun : _[peur](), [vol](), [boule de feu](), [don des langues]()_  
1/jour chacun : _[brume mortelle](), [changement de plan]()_  
**Résistance à la magie**.  
**Armes magiques**.  
**Régénération**.  
A|**Attaques multiples**.  
A|**Morsure (forme de slaad uniquement)**. +9, 1,50 m, 1d8+5 perforants  
...
Aberration (métamorphe) de taille M, chaotique neutre
...
**Régénération**.  
A|**Attaques multiples**.  
A|**Morsure (forme de slaad uniquement)**. +7, 1,50 m, 1d6+3 perforants  
...
**Métamorphe**.  
**Incantation innée**.  
À volonté : _[détection de la magie](), [détection des pensées](), [main de mage]()_  
2/jour chacun : _[peur](), [invisibilité]()_ (personnel)  
1/jour : _[boule de feu]()_  
**Résistance à la magie**.  
**Régénération**.  
A|**Attaques multiples**.  
A|**Morsure (forme de slaad uniquement)**. +7, 1,50 m, 2d6+4 perforants  
A|**Griffes (forme de slaad uniquement)**. +7, 1,50 m, 1d6+4 tranchants  
...
**Résistances** radiant ; contondant, perforant et tranchant d'attaques non magiques  
**Immunités** nécrotique, poison  
**Immunités** charmé, effrayé, empoisonné, épuisement  
**Sens** vision véritable 36 m, Perception passive 24  
**Langues** toutes, télépathie 36 m  
**Puissance** 21 (33000 PX)
...
**Incantation innée**.  
À volonté : _[détection du mal et du bien](-du-bien), [invisibilité]()_ (personnel uniquement)  
3/jour chacun : _[barrière de lames](), [dissipation du mal et du bien](-du-bien), [résurrection]()_  
1/jour chacun : _[communion](), [contrôle du climat]()_  
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Épée à deux mains**. +15, 1,50 m, 4d6+8 tranchants  
A|**Arc long Tueur**. +13, 45/180 m, 2d8+6 perforants  
A|**Épée volante**.  
A|**Contact guérisseur (4/jour)**.  
L|**Téléportation**.  
L|**Explosion brûlante (coûte 2 actions)**.  
...
\[ Deathlock Mastermind \] \[ Sorcemort, cerveau \]
...
**Immunités** poison  
**Immunités** épuisement, empoisonné  
**Sens** vision dans le noir 36 m (traverse les ténèbres magiques), Perception passive 14  
**Langues** les langues qu'il connaissait de son vivant  
**Puissance** 8 (3900 PX)
...
Élementaire de taille G, typiquement neutre mauvais
...
A|**Morsure**.  
A|**Rayons oculaires**.  
A|**1- Rayon de confusion**.  
A|**2- Rayon paralysant**.  
A|**3- Rayon de peur**.  
A|**4- Rayon de blessure**.  
...
**Résistances** acide, froid, feu, foudre, tonnerre ; contondant, perforant et tranchant d'attaques non magiques  
**Immunités** nécrotique, poison  
**Immunités** charmé, épuisement, entravé, paralysé, pétrifié, empoisonné, à terre, agrippé, inconscient  
**Sens** vision dans le noir 18 m, Perception passive 10  
**Langues** comprend les langues qu'il connaissait de son vivant mais ne peut pas parler  
**Puissance** 1 (200 PX)
...
Morsure (sous forme de chauve-souris ou de vampire uniquewmnt).  
Charme.  
...
**Lien télépathique**.  
**Métamorphe**.  
A|**Griffes (forme fiélone uniquement)**. +5, 1,50 m, 1d6+3 tranchants  
A|**Charme**.  
A|**Baiser corrupteur**.  
A|**Forme éthérée**.  
...
**Monstre de siège**.  
A|**Attaques multiples**.  
A|**Coup**. +10, 1,50 m, 3d6+6 contondants  
A|**Rocher**. +10, 18/54 m, 4d10+6 contondants  
...
A|**Attaques multiples**.  
A|**Griffes**. +2, 1,50 m, 1d4 tranchants  
A|**Fléchettes**. +4, 6/18 m, 1d4+2 perforants  
...
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Morsure**. +7, 1,50 m, 1d8+4 perforants  
A|**Épée à deux mains**. +7, 1,50 m, 2d6+4 tranchants  
R|**Furie effrénée**.  
...
\[ Rug of Smothering \] \[ Tapis étrangleur \]
...
**Immunités** charmé, effrayé, empoisonné, paralysé  
...
**Monstre de siège**.  
A|**Attaques multiples**.  
A|**Cornes**. +19, 3 m, 4d10+10 perforants  
A|**Griffes**. +19, 4,50 m, 4d8+10 tranchants  
A|**Morsure**. +19, 3 m, 4d12+10 perforants  
A|**Queue**. +19, 6 m, 4d6+10 contondants  
A|**Présence effrayante**.  
A|**Engloutissement**.  
L|**Attaque**.  
L|**Déplacement**.  
...
**Relai télépathique**.  
A|**Attaques multiples**.  
A|**Morsure**. +5, 1,50 m, 4d6+2 perforants  
A|**Tentacules**. +5, 1,50 m, 4d8+2 psychiques  
A|**Rayons oculaires**.  
A|**1- Rayon de dégoût**.  
A|**2- Rayon de peur**.  
A|**3- Rayon psychique**.  
A|**4- Rayon de lenteur**.  
A|**5- Rayon étourdissant**.  
...
**Immunités** aveuglé, assourdi, épuisement  
**Sens** vision aveugle 18 m (aveugle au-delà de ce rayon), Perception passive 9  
**Langues** —  
**Puissance** 6 (2300 PX)

A|**Attaques multiples**.  
A|**Morsure**. +9, 3 m, 6d10+6 perforants  
A|**Appendice**. +4, 4,50 m, 1d6+6 contondants  
A|**Engloutissement**.  
...
Mort-vivant de taille TG, typiquement chaotique mauvais
...
Mort-vivant de taille TG, chaotique mauvais
...
Fiélon de taille Gig, chaotique mauvais
...
**Immunités** acide, froid, feu, foudre, poison ; contondant, perforant et tranchant d'attaques non magiques  
**Immunités** aveuglé, charmé, assourdi, effrayé, empoisonné, étourdi  
**Sens** vision dans le noir 72 m, vision véritable 36 m, Perception passive 36  
...
**Odorat aiguisé**.  
**Bond agressif**.  
A|**Griffes**. +6, 1,50 m, 2d6+5 tranchants  
...
A|**Attaques multiples (forme humanoïde ou hybride uniquement)**.  
A|**Morsure (forme de tigre ou hybride uniquement)**. +5, 1,50 m, 1d10+3 perforants  
A|**Griffes (forme de tigre ou hybride uniquement)**. +5, 1,50 m, 1d8+3 tranchants  
A|**Cimeterre (forme humanoïde ou hybride uniquement)**. +5, 1,50 m, 1d6+3 tranchants  
...
A|**Attaques multiples**.  
A|**Épée longue**. +6, 1,50 m, 1d8+3 tranchants  
A|**Chaîne barbelée**. +6, 3 m, 1d6+3 perforants  
...
Humanoïde (torte) de taille M, loyal neutre
...
Humanoïde (torte) de taille M, loyal bon
...
**Résistances** contondant, perforant et tranchant d'attaques non magiques  
**Immunités** foudre, poison, tonnerre  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[lumière](), [réparation](), [](), [rayon de givre]()_  
Niv 1 (4) : _[orbe chromatique](), [repli expéditif]()\*, [armure de mage]()_  
Niv 2 (3) : _[modification d'apparence]()\*, [immobilisation de personne](), [déblocage]()\*_  
Niv 3 (3) : _[clignotement]()\*, [boule de feu](), [lenteur]()\*_  
Niv 4 (3) : _[métamorphose]()\*, [peau de pierre]()_  
Niv 5 (1) : _[télékinésie]()\*_  
...
• Résistance aux dommages causés par l'acide, le froid, le feu, la foudre ou le tonnerre (au choix du transmutateur lorsqu'il choisit cet avantage)  
Si le transmutateur a la pierre et lance un sort de transmutation de niveau 1 ou supérieur, il peut changer l'effet de la pierre.  
A|**Bâton**.  
...
\[ Slithering Tracker \] \[ Traquatique \]

Vase de taille M, typiquement chaotique mauvais
...
**Pattes d'araignée**.  
**Discrétion aqueuse**.  
A|**Coup**. +5, 1,50 m, 1d10+3 contondants  
A|**Suceur de vie**.  
...
**Charge écrasante**.  
A|**Corne**. +9, 1,50 m, 4d8+6 perforants  
...
\[ Firenewt Warrior \] \[ Triton du feu, combattant \]
...
Élémentaire de taille M, typiquement neutre mauvais
...
**Incantation innée**.  
**Incantation**.  
Sorts mineurs (à volonté) : _[trait de feu](), [assistance](), [lumière](), [main de mage](), [prestidigitation]()_  
Nivx 1-2 (2 de niveau 2) : _[mains brûlantes](), [sphère de feu](), [représailles infernales](), [rayon ardent]()_  
**Bénédiction d'Imix**.  
...
**Incantation innée**.  
À volonté : _[armure de mage]() (personnel uniquement), [communication avec les animaux](), [lévitation]() (personnel uniquement), [modification d'apparence](), [oeil magique]()_  
1/jour chacun : _[cage de force](), [doigt de mort](), [esprit faible]()_  
**Incantation**.  
Sorts mineurs (à volonté) : _[amis](), [décharge occulte](), [illusion mineure](), [main de mage](), [bouffée de poison]()_  
Nivx 1 à 5 (4 de niveau 5) : _[bannissement](), [cercle magique](), [colonne de flamme](), [représailles infernales](), [mains brûlantes](), [mur de feu](), [nuage nauséabond](), [rayon ardent](), [représailles infernales](), [suggestion]()_  
**Chance du ténébreux (Recharge après un repos court ou long)**.  
A|**Masse d'armes**. +3, 1,50 m, 1d6 contondants  
...
**Respiration aquatique**.  
A|**Morsure**. +4, 1,50 m, 1d4+2 perforants  
A|**Queue**. +4, 1,50 m, 1d4+2 contondants  
...
**Compétences** Perception +12  
**Immunités** poison  
**Immunités** charmé, épuisement, paralysé, pétrifié, empoisonné, à terre  
**Sens** vision dans le noir 36 m, Perception passive 22  
**Langues** profond, commun des profondeurs  
**Puissance** 14 (11500 PX)

**Cône d'énergie négative**.  
A|**Morsure**. +5, 1,50 m, 4d6 perforants  
A|**Rayons oculaires**.  
A|**1- Rayon de charme**.  
A|**2- Rayon paralysant**.  
A|**3- Rayon de peur**.  
A|**4- Rayon de lenteur**.  
A|**5- Rayon affaiblissant**.  
A|**6- Rayon télékinétique**.  
A|**7- Rayon de sommeil**.  
A|**8- Rayon de pétrification**.  
A|**9- Rayon de désintégration**.  
A|**10- Rayon de mort**.  
L|**Rayon oculaire**.  
...
A|**Attaques multiples**.  
A|**Morsure**. +10, 3 m, 4d12+7 perforants  
...
**Incantation innée (psioniques)**.  
À volonté : _[détection des pensées](), [lévitation]()_  
1/jour chacun : _[domination de personne](), [confusion](), [mauvais oeil](), [esprit faible](), [suggestion de groupe](), [projection d'image](), [scrutation](), [télékinésie](), [changement de plan]()_ (personnel uniquement)  
A|**Tentacules**. +9, 3 m, 4d10+5 psychiques  
A|**Extraction de cerveau**. +9, 1,50 m, 10d10 perforants  
A|**Explosion de l'esprit (Recharge 5-6)**.  
...
**Incantation innée**.  
À volonté : _[modification d'apparence](), [clairvoyance](), [ténèbres](), [détection de la magie](), [détection des pensées](), [dissipation de la magie](), [invisibilité]()_ (personnel uniquement), _[suggestion]()_  
3/jour chacun : _[porte dimensionnelle](), [peur](), [mur de feu]()_  
1/jour chacun : _[tempête de feu](), [suggestion de groupe]()_  
**Résistance à la magie**.  
**Armes magiques**.  
A|**Attaques multiples**.  
A|**Épée longue**. +8, 1,50 m, 1d8+3 tranchants  
A|**Regard hypnotique**.  
A|**Téléportation**.  
...
**Classe d'armure** 14 (_Bâton noir_ ; 17 avec _[armure de mage]()_)  
**Points de vie** 126 (23d8 + 23)  
**Vitesse** 9 m
...
**Interdiction**.  
**Détruit par les étendues d'eau courante**.  
**Un pieu dans le cœur**.  
**Hypersensibilité au soleil**.  
A|**Attaques multiples (forme de vampire uniquement)**.  
A|**Attaque à mains nues (forme de vampire uniquement)**. +9, 1,50 m, 1d8+4 contondants  
A|**Morsure (forme de vampire ou de chauve-souris uniquement)**. +9, 1,50 m, 1d6+4 perforants  
A|**Charme**.  
A|**Enfants de la nuit (1/jour)**.  
L|**Déplacement**.  
...
**Hypersensibilité au soleil**.  
A|**Attaques multiples**.  
A|**Griffes**. +6, 1,50 m, 2d4+3 tranchants  
...
Aberration (tyrannoeil) de taille G, typiquement neutre mauvais
...
**Sang de foudre**.  
A|**Attaques multiples**.  
A|**Tentacule**. +8, 6 m, 3d6+4 perforants  
...
**Résistances** foudre, froid, nécrotique  
**Immunités** poison ; contondant, perforant et tranchant d'attaques non magiques  
...
A|**Attaques multiples**.  
A|**Après-coup**.  
A|**Volée des damnés (Recharge 5–6)**.  
A|**Destin funeste**.  
A|**Incantation**.  
...
Plante de taille M, typiquement neutre
...
**Fouisseur**.  
A|**Attaques multiples**.  
A|**Morsure**. +14, 3 m, 3d8+9 perforants  
...
**Incantation**.  
Sorts mineurs (à volonté) : _[prestidigitation](), [réparation](), [trait de feu]()_  
Niv 1 (2) : _[bouclier](), [déguisement](), [mains brûlantes]()_  
A|**Bâton**.  
...
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Bec**. +6, 1,50 m, 2d6+3 perforants  
A|**Serres**. +6, 1,50 m, 2d10+3 tranchants  
A|**Spores (Recharge 6)**.  
...
A|**Attaques multiples**.  
A|**Dard**. +7, 3 m, 2d6+4 perforants  
A|**Griffes**. +7, 1,50 m, 2d8+4 tranchants  
...
**Résistances** psychique, poison  
**Sens** vision dans le noir 18 m, Perception passive 11  
**Langues** commun, gobelin  
**Puissance** 4 (1100 PX)

**Incantation innée**.  
À volonté : _[image silencieuse](), [saut](), [lévitation](), [armure de mage]()_ (personnel uniquement), _[communication avec les morts]()_  
1/jour chacun : _[vision suprême]()_  
**Incantation**.  
Sorts mineurs (à volonté) : _[amis](), [contact glacial](), [décharge occulte](), [illusion mineure](), [main de mage](), [prestidigitation](), [protection contre les armes]()_  
Niv 1-5 (3 de niveau 5) : _[armure d'Agathys](), [bannissement](), [compréhension des langues](), [contact avec un autre plan](-plan), [couronne du dément](), [immobilisation de monstre](), [peur](), [porte dimensionnelle](), [tentacules de Hadar](), [toucher du vampire](), [détection des pensées]()_  
**Nature immortelle**.  
A|**Dague**. +3, 1,50 m ou 6/18 m, 1d4+2 perforants  
...
**Incantation innée**.  
À volonté : _[détection de la magie](), [armure de mage]()_ (personnel uniquement)  
**Incantation**.  
Sorts mineurs (à volonté) : _[décharge occulte](), [main de mage](), [illusion mineure](), [bouffée de poison](), [prestidigitation]()_  
Nivx 1-2 (2 de niveau 2) : _[mains brûlantes](), [repli expéditif](), [invisibilité](), [rayon ardent]()_  
**Action fourbe mineure**.  
**Bénédiction de Raxivort**.  
**Langue de Raxivort**.  
A|**Cimeterre**. +4, 1,50 m, 1d6+2 tranchants  
...
Damage immunities foudre, poison, tonnerre  
**Immunités** charmé, effrayé, paralysé, pétrifié, empoisonné, à terre, entravé  
...
**Odorat aiguisé**.  
A|**Attaques multiples**.  
A|**Griffes**. +6, 1,50 m, 1d6+4 tranchants  
A|**Regard givrant**.  
...
Monstruosité de taille TG, chaotique mauvais
...
**Odorat aiguisé**.  
A|**Attaques multiples**.  
A|**Griffes**. +11, 1,50 m, 2d6+7 tranchants  
A|**Regard givrant**.  
...
Fiélon (démon, métamorphe) de taille M, chaotique mauvais
...
**Résistances** froid feu, foudre ; contondant, tranchant, et perforant d'attaques non magiques  
**Immunités** poison  
**Immunités** empoisonné  
**Sens** vision dans le noir 36 m, Perception passive 12  
**Langues** abyssal, elfique, commun des profondeurs  
...
**Pattes d'araignée**.  
**Incantation innée**.  
À volonté : _[détection des pensées](), [toile d'araignée]()_  
1/jour : _[domination de personne]()_  
**Déplacement sur la toile**.  
A|**Attaques multiples**.  
...
\[ Yuan-ti Abomination \] \[ Abomination yuan-tie \]

Monstruosité (métamorphe, yuan-ti) de taille G, neutre mauvais
...
À volonté : _[amitié avec les animaux]()_ (serpents uniquement)  
3/jour : _[suggestion]()_  
1/jour : _[peur]()_  
**Résistance à la magie**.  
A|**Attaques multiples (forme d'abomination uniquement)**.  
A|**Morsure**. +7, 1,50 m, 1d6+4 perforants  
A|**Constriction**. +7, 3 m, 2d6+4 contondants  
A|**Cimeterre (forme d'abomination uniquement)**. +7, 1,50 m, 2d6+4 tranchants  
...
Déluge de morsures (forme d'anathème uniquement).  
Constriction (forme de serpent uniquement).  
Incantation (forme d'anathème uniquement).  
Métamorphe.  
...
À volonté : _[amitié avec les animaux]()_ (serpents uniquement)  
3/jour chacun : _[ténèbres](), [enchevêtrement](), [peur](), hâte, [suggestion](), polymorphe_  
1/jour : _[parole divine]()_  
**Résistance à la magie**.  
**Aura d'ophidiophobie**.  
**Métamorphe**.  
**Six têtes**.  
A|**Attaques multiples (forme d'anathème uniquement)**.  
A|**Griffes (forme d'anathème uniquement)**. +10, 3 m, 2d6+6 tranchants  
A|**Constriction**.  
...
\[ Yuan-ti Nightmare Speaker \] \[ Yuan-ti, orateur des cauchemars \]
...
**Résistance à la magie**.  
**Incantation (forme de yuan-ti uniquement)**.  
Sorts mineurs (à volonté) : _[contact glacial](), [décharge occulte]()_ (portée 90 m, bonus de +3 à chaque jet de dégâts), _[main de mage](), [message](), [bouffée de poison](), [prestidigitation]()_  
Niv 1 à 3 (2 de niveau 3) : _[tentacules de Hadar](), [ténèbres](), [peur](), [maléfice](), [immobilisation de personne](), [voracité de Hadar](), [trait ensorcelé]()_  
A|**Attaques multiples (forme de yuan-ti uniquement)**.  
A|**Constriction**. +5, 3 m, 2d6+3 contondants  
...
**Incantation (forme de yuan-ti uniquement)**.  
Sorts mineurs (à volonté) : _[décharge occulte]()_ (portée 90 mètres, bonus de +3 à chaque jet de dégâts), _[amis](), [message](), [illusion mineure](), [bouffée de poison](), [prestidigitation]()_  
Niv 1-3 (2 de niveau 3) : _[charme-personne](), [couronne du dément](), [détection des pensées](), [repli expéditif](), [vol](), [motif hypnotique](), [texte illusoire]()_  
**Bénédiction de Sseth**.  
A|**Attaques multiples (forme de yuan-ti uniquement)**.  
A|**Morsure**. +5, 1,50 m, 1d4+3 perforants  
A|**Cimeterre (forme de yuan-ti uniquement)**. +5, 1,50 m, 1d6+3 tranchants  
...
**Incantation (forme de yuan-ti uniquement)**.  
Sorts mineurs (à volonté) : _[décharge occulte]()_ (portée 90 mètres, bonus de +3 à chaque jet de dégâts), _[amis](), [assistance](), [main de mage](), [message](), [bouffée de poison]()_  
Niv 1-3 (2 de niveau 3) : _[injonction](), [contresort](), [représailles infernales](), [invisibilité](), [invisibilité](), [serviteur invisible](), toucher du vampire_  
A|**Attaques multiples (forme Yuan-ti uniquement)**.  
A|**Morsure**. +5, 1,50 m, 1d4+3 perforants  
...
Pour le Type 3  
A|**Attaques multiples (forme de yuan-ti uniquement)**.  
A|**Morsure (forme de serpent uniquement)**. +5, 1,50 m, 1d4+3 perforants  
A|**Constriction**. +5, 1,50 m, 2d6+3 contondants  
A|**Cimeterre (forme de yuan-ti uniquement)**. +5, 1,50 m, 1d6+3 tranchants  
A|**Arc long (forme de yuan-ti uniquement)**. +4, 45/180 m, 1d8+2 perforants  
...
**Résistances** froid, feu, radiant ; contondant, perforant et tranchant d'attaques non magiques qui ne sont pas en argent  
**Immunités** nécrotique, poison  
**Immunités** charmé, épuisement, effrayé, empoisonné  
...
**Armes ardentes**.  
**Incantation innée**.  
À volonté : _[modification d'apparence]()_ (peut devenir de taille M lors de son changement d'apparence), _[détection du mal et du bien](-du-bien), [boule de feu](), [invisibilité]()_ (personnel uniquement), _[mur de feu]()_  
3/jour chacun : _[barrière de lames](), [dissipation du mal et du bien](-du-bien), [doigt de mort]()_  
**Résistance légendaire (3/jour)**.  
**Résistance à la magie**.  
**Régénération**.  
A|**Attaques multiples**.  
A|**Épée longue**. +16, 3 m, 2d8+8 tranchants  
A|**Javeline**. +16, 3 m ou 9/36 m, 2d6+8 perforants  
A|**Contact affreux (Recharge 5-6)**. +16, 3 m, 8d10 nécrotiques  
A|**Téléportation**.  
L|**Regard immolant (coûte 2 actions)**.  
L|**Téléportation**.  
...
**Résistance à la magie**.  
A|**Attaques multiples**.  
A|**Morsure**. +6, 1,50 m, 1d10+3 perforants  
A|**Cimeterre**. +6, 1,50 m, 1d6+3 force  
A|**Convocation de nupperibos (Recharge après un repos court ou long)**.  
A|**Téléportation (dans le château uniquement)**.  
...
**Tenacité de mort-vivant**.  
A|**Coup**. +3, 1,50 m, 1d8+1 contondants  
...
**Sauvegardes** Sag +2  
**Immunités** poison  
**Immunités** à terre, empoisonné  
**Sens** vision dans le noir 18 m, Perception passive 9  
**Langues** comprend le profond et le commun des profondeurs mais ne peut pas parler  
**Puissance** 5 (1800 PX)

**Tenacité de mort-vivant**.  
A|**Morsure**. +3, 1,50 m, 4d6 perforants  
A|**Rayons oculaires**.  
A|**1- Rayon paralysant**.  
A|**2- Rayon de peur**.  
...
Spores contrôleuses d'esprit (Recharge 5–6).  
